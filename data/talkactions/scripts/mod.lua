function onSay(player, words, param)
	...
	if thing:isItem() then
		...
		thing:setAttributeValue(tonumber(split[1]), tonumber(split[2]).."|"..tonumber(split[3]).."|"..tonumber(split[4]))

		thing:getPosition():sendMagicEffect(50)
		player:sendTextMessage(MESSAGE_INFO_DESCR,"Item set Mod 1 Slot ID i, 2 ID mod, 3 value, 4 Tier")
	end
	return true
end
