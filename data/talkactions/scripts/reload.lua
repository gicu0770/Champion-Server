local reloadTypes = {
	...
	["outline"] = RELOAD_TYPE_OUTLINES,
	["outlines"] = RELOAD_TYPE_OUTLINES,
...
function onSay(player, words, param)
	...
	for _, targetPlayer in ipairs(Game.getPlayers()) do
		colleftInfo[targetPlayer:getId()] = nil
		targetPlayer:setCollectionInfo()
	end
