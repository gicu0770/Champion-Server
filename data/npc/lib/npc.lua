...
function doNpcSellItem(cid, itemid, amount, subType, ignoreCap, inBackpacks, backpack, extraItemFunc)
	...
	for i = 1, amount do -- normal method for non-stackable items
		local item = doCreateItemEx(itemid, subType, extraItemFunc, cid)
