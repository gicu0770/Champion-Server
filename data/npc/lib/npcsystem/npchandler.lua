...
if NpcHandler == nil then
	...
	function NpcHandler:processModuleCallback(id, ...)
		...
		for i, module in pairs(self.modules) do
			...
			elseif id == CALLBACK_ONSELLMULTIPLE and module.callbackOnSellMultiple then
				tmpRet = module:callbackOnSellMultiple(...)
			end
			if not tmpRet then
				ret = false
				break
	...
	function NpcHandler:getShopModule()
		for i, module in pairs(self.modules) do
			if module.callbackOnBuy or module.callbackOnSell then
				return module
			end
		end
		return nil
	...
	function NpcHandler:onPlayerSellMultiple(creature, items)
		local cid = creature:getId()
		for i, module in pairs(self.modules) do
			if module.callbackOnSellMultiple then
				module:callbackOnSellMultiple(cid, items)
				break
			end
		end
	end
	...
	function NpcHandler:onSell(creature, itemid, subType, amount, realUID, ignoreCap, inBackpacks)
		local cid = creature:getId()
		for i, module in pairs(self.modules) do
			if module.callbackOnSell then
				module:callbackOnSell(cid, itemid, subType, amount, realUID, ignoreCap, inBackpacks)
				break
			end
		end
	end
