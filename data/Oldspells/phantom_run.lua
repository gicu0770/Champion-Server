local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[55].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[55].manaCost,
  spellId = 55,
  range = GLOBAL_SPELL_COOLDOWNS[55].range,
  aggressive = true,
  targets = 0,
  needTarget = false,
  cooldown = GLOBAL_SPELL_COOLDOWNS[55].cooldown,
