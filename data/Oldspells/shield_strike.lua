...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[107].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[107].manaCost,
  spellId = 107,
  range = GLOBAL_SPELL_COOLDOWNS[107].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[107].cooldown,
