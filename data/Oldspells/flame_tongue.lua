...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[90].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[90].manaCost,
  spellId = 90,
  range = GLOBAL_SPELL_COOLDOWNS[90].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[90].cooldown,
  type = COMBAT_FIREDAMAGE,
  targets = GLOBAL_SPELL_COOLDOWNS[90].split,
