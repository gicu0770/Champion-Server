...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[106].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[106].manaCost,
  spellId = 106,
  range = GLOBAL_SPELL_COOLDOWNS[106].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[106].cooldown,
