...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[103].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[103].manaCost,
  spellId = 103,
  range = GLOBAL_SPELL_COOLDOWNS[103].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[103].cooldown,
