...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[104].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[104].manaCost,
  spellId = 104,
  range = GLOBAL_SPELL_COOLDOWNS[104].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[104].cooldown,
