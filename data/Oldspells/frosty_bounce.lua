local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[109].name,
  level = 1,
  magLevel = 0,
  manaCost = GLOBAL_SPELL_COOLDOWNS[109].manaCost,
  spellId = 109,
  range = GLOBAL_SPELL_COOLDOWNS[109].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[109].cooldown,
  type = COMBAT_ICEDAMAGE,
  -- sameTarget = true,

  timeBeetwean = 0,
  bounces = {
    max = GLOBAL_SPELL_COOLDOWNS[109].bon,
    chance = 100,
    -- sameTarget = true,
  },
