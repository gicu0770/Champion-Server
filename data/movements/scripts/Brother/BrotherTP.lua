local config = {
	teleportRoom = {x = 592, y = 1977, z = 8},
	area = {x = 591, y = 1967, z = 8},
	posKickQuestDone = {x = 711, y = 1034, z = 7}, --only if you want kick after done quest
	rangeArena = 14,
	bossName = "brotherhood master",
	enterText = "You entered the area of the Brotherhood Master Boss, there is no way out of this place until you kill him!.",
	monstersPos = {{x = 591, y = 1957, z = 8}}
}
