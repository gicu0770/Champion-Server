local config = {
	teleportRoom = {x = 355, y = 780, z = 9},
	area = {x = 355, y = 767, z = 9},
	rangeArena = 15,
	bossName = "Orclops Orion",
	enterText = "You entered the area of the Orclops Orion Boss, there is no way out of this place until you kill him!.",
	monstersPos = {{x = 355, y = 760, z = 9}}
}
