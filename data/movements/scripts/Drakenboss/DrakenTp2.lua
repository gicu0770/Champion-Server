local config = {
	pPos = {x = 697, y = 612, z = 10},
	storages = {25001},
	tpPos = {x = 697, y = 612, z = 10},
	monstersPos = {{x = 685, y = 591, z = 10}}
}

function checkArea()
	local creatrures = Game.getSpectators({x = 685, y = 600, z = 10}, false, false, 13, 13, 13, 13)
	local monsters = {}
