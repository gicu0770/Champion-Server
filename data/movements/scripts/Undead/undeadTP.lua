local config = {
	teleportRoom = {x = 560, y = 1651, z = 11},
	area = {x = 560, y = 1642, z = 11},
	posKickQuestDone = {x = 711, y = 1034, z = 7}, --only if you want kick after done quest
	rangeArena = 12,
	bossName = "undead grave lord",
	enterText = "You entered the area of the Undead Grave Lord Boss, there is no way out of this place until you kill him!.",
	monstersPos = {{x = 560, y = 1638, z = 11}}
}
