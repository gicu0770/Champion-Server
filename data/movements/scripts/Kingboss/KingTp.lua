local config = {
	teleportRoom = {x = 1301, y = 541, z = 10},
	area = {x = 1303, y = 553, z = 10},
	posKickQuestDone = {x = 711, y = 1034, z = 7}, --only if you want kick after done quest
	rangeArena = 13,
	bossName = "Forgotten King",
	enterText = "You entered the area of the Forgotten King Boss, there is no way out of this place until you kill him!.",
