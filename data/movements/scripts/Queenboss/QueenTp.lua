local config = {
	teleportRoom = {x = 1332, y = 536, z = 7},
	area = {x = 1332, y = 527, z = 7},
	posKickQuestDone = {x = 711, y = 1034, z = 7}, --only if you want kick after done quest
	rangeArena = 10,
	bossName = "Forgotten Queen",
	enterText = "You entered the area of the Forgotten Queen Boss, there is no way out of this place until you kill him!.",
