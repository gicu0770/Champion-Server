local config = {
	pPos = {x = 1332, y = 536, z = 7},
	storages = {25002},
	tpPos = {x = 1332, y = 536, z = 7},
	monstersPos = {{x = 1332, y = 520, z = 7}}
}

function checkArea()
	local creatrures = Game.getSpectators({x = 1332, y = 527, z = 7}, false, false, 10, 10, 10, 10)
	local monsters = {}
