if not Metin then
	...
	{x = 1580, y = 1280, z = 7},
	{x = 1512, y = 1291, z = 7},
	{x = 1612, y = 1280, z = 7}	-- humubgus														1559, y = 1324, z = 7
    }
    ...
    function Metin.getRandomSpawn()
        ...
        for i = 1, #Metin.cfg.spawns do
            ...
            if t ~= nil then
                ...
                if(creaturesOnTile and #t:getCreatures() == 0) or isBadTile(t) then --Delete this if you want to avoid spawn block (almost impossible to block all if have a lot of spawns)
