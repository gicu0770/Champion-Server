local CONFIG = {
  spellName = "Flicker Strike",
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[20].manaCost,
  spellId = 20,
  range = GLOBAL_SPELL_COOLDOWNS[20].range,
  aggressive = true,
  targets = 0,
  needTarget = false,
  cooldown = GLOBAL_SPELL_COOLDOWNS[20].cooldown,
