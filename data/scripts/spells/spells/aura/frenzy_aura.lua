local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[65].name,
  level = 1,
  magLevel = 0,
  spellId = 65,
  manaReservation = GLOBAL_SPELL_COOLDOWNS[65].manaReservation,
  buff = FRENZY_AURA,
  cooldown = 3000,
...
CONFIG.supports["eleMastery"] = false
CONFIG.supports["dualMastery"] = false
...
local function castSpell(player, item, getInfoOnly)
  ...
  player:getTotalAttackSpeed(true)
end
