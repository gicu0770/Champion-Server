...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[94].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[94].manaCost,
  spellId = 94,
  range = GLOBAL_SPELL_COOLDOWNS[94].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[94].cooldown,
  type = COMBAT_PHYSICALDAMAGE,
  targets = GLOBAL_SPELL_COOLDOWNS[94].split,
