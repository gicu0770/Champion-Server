local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[96].name,
  level = 1,
  magLevel = 0,
  manaCost = GLOBAL_SPELL_COOLDOWNS[96].manaCost,
  spellId = 96,
  range = GLOBAL_SPELL_COOLDOWNS[96].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[96].cooldown,
  type = COMBAT_ICEDAMAGE,
  -- sameTarget = true,

  timeBeetwean = 0,
  bounces = {
    max = GLOBAL_SPELL_COOLDOWNS[96].bon,
    chance = 100,
    -- sameTarget = true,
  },
