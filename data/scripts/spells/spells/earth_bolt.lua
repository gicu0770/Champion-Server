...
local CONFIG = {
  spellName = GLOBAL_SPELL_COOLDOWNS[40].name,
  level = 1,
  magLevel = 0,
  precentCost = true,
  manaCost = GLOBAL_SPELL_COOLDOWNS[40].manaCost,
  spellId = 40,
  range = GLOBAL_SPELL_COOLDOWNS[40].range,
  aggressive = true,
  forwardCast = true,
  cooldown = GLOBAL_SPELL_COOLDOWNS[40].cooldown,
  type = COMBAT_EARTHDAMAGE,
  targets = GLOBAL_SPELL_COOLDOWNS[40].split,
