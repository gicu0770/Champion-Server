...
function arenaPit.onStepIn(creature, item, position, fromPosition)
	...
	if pitId > 10 then
		...
		if arenaId == 1 then
			...
			player:setStorageValue(Storage.SvargrondArena.TrophyGreenhorn, 1)
			player:setStorageValue(Storage.SvargrondArena.RewardGreenhorn, 1)
		...
		elseif arenaId == 2 then
			...
			player:setStorageValue(Storage.SvargrondArena.TrophyScrapper, 1)
			player:setStorageValue(Storage.SvargrondArena.RewardScrapper, 1)
		...
		elseif arenaId == 3 then
			...
			player:setStorageValue(Storage.SvargrondArena.TrophyWarlord, 1)
			player:setStorageValue(Storage.SvargrondArena.RewardWarlord, 1)
			player:say("Respect and honour to you, champion!", TALKTYPE_MONSTER_SAY) --RewardGreenhorn
		end
