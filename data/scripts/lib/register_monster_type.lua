...
registerMonsterType.items = function(mtype, mask)
	if mask.items then
		mtype:items(mask.items)
	end
end
...
registerMonsterType.zone = function(mtype, mask)
	if mask.zone then
		mtype:zoneId(mask.zone)
	end
end
registerMonsterType.bestiary = function(mtype, mask)
	if mask.bestiary then
		mtype:bestiaryId(mask.bestiary)
	end
end
