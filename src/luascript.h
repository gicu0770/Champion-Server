...
class LuaScriptInterface
{
	public:
		...
		static ScriptEnvironment* getScriptEnv() {
			assert(scriptEnvIndex >= 0 && scriptEnvIndex < 256);
			return scriptEnv + scriptEnvIndex;
		}

		static bool reserveScriptEnv() {
			return ++scriptEnvIndex < 256;
		}
	...
	private:
		...
		static int luaSaveServerAsync(lua_State* L);
		...
		// InstaceManager
		static int luaInstanceManagerStartInstance(lua_State* L);
		static int luaInstanceManagerForceClose(lua_State* L);
		...
		static int luaGameGetMarketItems(lua_State* L);
		static int luaGameGetItemIdByClientId(lua_State* L);

		static int luaGameGetMonsterTypeByBestiaryId(lua_State* L);
		static int luaGameGetMonstersTypeByZoneId(lua_State* L);

		static int luaGameGetHouseById(lua_State* L);

		static int luaGameScanAllPlayerItems(lua_State* L);
		...
		static int luaPositionGetDirectionTo(lua_State* L);

		static int luaPositionSendMagicEffect(lua_State* L);
		static int luaPositionSendLineEffect(lua_State* L);
		...
		static int luaTileSetWidget(lua_State* L);
		static int luaTileRemoveWidget(lua_State* L);
		...
		static int luaItemGetColor(lua_State* L);
		...
		static int luaItemSetRealUID(lua_State *L);
		static int luaItemUpdateSelf(lua_State *L);
		static int luaItemGetSpellName(lua_State *L);
		static int luaItemGetPotionName(lua_State *L);
		static int luaItemGetPotionId(lua_State *L);
		static int luaItemIsRelictBox(lua_State *L);
		static int luaItemGetLootIndex(lua_State *L);

		// Container
		static int luaContainerCreate(lua_State* L);

		static int luaContainerGetSize(lua_State* L);
		static int luaContainerSetSize(lua_State* L);
		...
		static int luaContainerGetItemUID(lua_State* L);
		static int luaContainerGetItemById(lua_State* L);
		...
		static int luaContainerSetCorpseOwner(lua_State* L);
		...
		static int luaCreatureGetTotalHealthGain(lua_State* L);
		static int luaCreatureGetTotalPrecentHealthGain(lua_State* L);
		static int luaCreatureGetTotalEnergyShieldGain(lua_State* L);
		static int luaCreatureGetTotalPrecentEnergyShieldGain(lua_State* L);

		static int luaCreatureAddHealthGain(lua_State* L);
		static int luaCreatureRemoveHealthGain(lua_State* L);
		static int luaCreatureAddHealthPrecentGain(lua_State* L);
		static int luaCreatureRemoveHealthPrecentGain(lua_State* L);

		static int luaCreatureGetEnergyShieldGain(lua_State* L);
		static int luaCreatureAddEnergyShieldGain(lua_State* L);
		static int luaCreatureRemoveEnergyShieldGain(lua_State* L);
		static int luaCreatureAddEnergyShieldPrecentGain(lua_State* L);
		static int luaCreatureRemoveEnergyShieldPrecentGain(lua_State* L);

		static int luaCreatureGetEnergyShieldGainForce(lua_State* L);
		static int luaCreatureGetEnergyShieldGainForceTotal(lua_State* L);
		static int luaCreatureAddEnergyShieldGainForce(lua_State* L);
		static int luaCreatureRemoveEnergyShieldGainForce(lua_State* L);
		static int luaCreatureAddEnergyShieldPrecentGainForce(lua_State* L);
		static int luaCreatureGetEnergyShieldPrecentGainForceTotal(lua_State* L);
		static int luaCreatureRemoveEnergyShieldPrecentGainForce(lua_State* L);
		...
		static int luaCreatureSetInPlace(lua_State *L);
		static int luaCreatureIsInPlace(lua_State *L);

		static int luaCreatureSendCreatureEffect(lua_State* L);
		static int luaCreatureSetTitle(lua_State* L);
		static int luaCreatureGetTitle(lua_State* L);

		static int luaCreatureGetZoneId(lua_State* L);
		static int luaCreatureGetBestiaryId(lua_State* L);

		static int luaCreatureSetFlying(lua_State* L);
		static int luaCreatureIsFlying(lua_State* L);
		...
		static int luaPlayerGetFirstLogin(lua_State* L);
		static int luaPlayerGetOnlineTime(lua_State* L);
		...
		static int luaPlayerGetTempStorage(lua_State* L);
		static int luaPlayerGetTradeStorage(lua_State* L);
		...
		static int luaPlayerGetTotalManaGain(lua_State* L);
		static int luaPlayerGetTotalPrecentManaGain(lua_State* L);
		static int luaPlayerAddManaGain(lua_State* L);
		static int luaPlayerRemoveManaGain(lua_State* L);
		static int luaPlayerAddManaPrecentGain(lua_State* L);
		static int luaPlayerRemoveManaPrecentGain(lua_State* L);

		static int luaPlayerGetRealMaxHealth(lua_State* L);
		static int luaPlayerGetRealMaxMana(lua_State* L);

		static int luaPlayerGetPrecentManaMultiplier(lua_State* L);
		static int luaPlayerGetPrecentHealthMultiplier(lua_State* L);
		static int luaPlayerGetPrecentEnergyShieldMultiplier(lua_State* L);

		static int luaPlayerGetReservation(lua_State* L);
		static int luaPlayerGetReservationTotal(lua_State* L);
		static int luaPlayerAddReservation(lua_State* L);
		static int luaPlayerRemoveReservation(lua_State* L);
		...
		static int luaPlayerGetShop(lua_State* L);
		static int luaPlayerSetShop(lua_State* L);
		...
		static int luaPlayerRemoveItemUnique(lua_State* L);
		
		static int luaPlayerAddItemToMarket(lua_State* L);
		static int luaPlayerCancelMarketOffer(lua_State* L);
		static int luaPlayerBuyMarketOffer(lua_State* L);
		static int luaPlayerUpdateStore(lua_State* L);
		static int luaPlayerIsShopping(lua_State* L);

		static int luaPlayerGetDungeonTier(lua_State* L);
		static int luaPlayerSetDungeonTier(lua_State* L);

		static int luaPlayerGetDPS(lua_State* L);
		static int luaPlayerSetDPS(lua_State* L);

		static int luaPlayerGetKills(lua_State* L);
		static int luaPlayerSetKills(lua_State* L);
		static int luaPlayerAddKill(lua_State* L);
		static int luaPlayerGetDeaths(lua_State* L);
		static int luaPlayerSetDeaths(lua_State* L);
		static int luaPlayerAddDeath(lua_State* L);

		static int luaPlayerCanSpendPoints(lua_State* L);
		static int luaPlayerAutoOpenContainers(lua_State* L);
		...
		static int luaPlayerGetTotalMoney(lua_State* L);
		static int luaPlayerRemoveTotalMoney(lua_State* L);
		...
		static int luaPlayerSetLimitMaxHealth(lua_State* L);
		static int luaPlayerGetLimitMaxHealth(lua_State* L);
		...
		static int luaPlayerAddOutline(lua_State* L);
		static int luaPlayerHasOutline(lua_State* L);
		...
		static int luaPlayerIsRecording(lua_State* L);
		static int luaPlayerStartRecording(lua_State* L);
		static int luaPlayerStopRecording(lua_State* L);
		
		static int luaPlayerGetItem(lua_State *L);
		static int luaPlayerGetPartyInfo(lua_State *L);
		static int luaPlayerSpellCheck(lua_State *L);
		static int luaPlayerTargetRechable(lua_State *L);
		...
		static int luaPlayerLogInfo(lua_State* L);
		static int luaPlayerGetContainerByPos(lua_State* L);
		...
		static int luaMonsterGetInstance(lua_State* L);
		...
		static int luaItemTypeGetColor(lua_State* L);
		...
		static int luaCombatSetParameterText(lua_State* L);
		...
		static int luaMonsterTypeZoneId(lua_State* L);
		static int luaMonsterTypeBestiaryId(lua_State* L);
		...
		static int luaMonsterTypeTier(lua_State* L);
		static int luaMonsterTypeItems(lua_State* L);
		...
		static int luaSpellDesc(lua_State* L);
		static int luaSpellIcon(lua_State* L);
		static int luaSpellImage(lua_State* L);
		static int luaSpellPower(lua_State* L);
		static int luaSpellType(lua_State* L);
		...
		static int luaDungeonSetCompleteType(lua_State* L);
		static int luaDungeonGetCompleteType(lua_State* L);

		static int luaDungeonSetSolo(lua_State* L);
		static int luaDungeonIsSolo(lua_State* L);
		...
		static int luaDungeonSetRequiredParagon(lua_State* L);
		static int luaDungeonGetRequiredParagon(lua_State* L);

		static int luaDungeonSetRequiredItemLevel(lua_State* L);
		static int luaDungeonGetRequiredItemLevel(lua_State* L);

		static int luaDungeonGetPlayersCount(lua_State* L);
		...
		static int luaCreatureAddFear(lua_State* L);
		static int luaCreatureRemoveFear(lua_State* L);
		static int luaCreatureHasFear(lua_State* L);

		static int luaCreatureAddActiveAura(lua_State* L);
		static int luaCreatureGetActiveAuras(lua_State* L);
		static int luaCreatureRemoveActiveAura(lua_State* L);
		...
		static int luaDungeonAddObjective(lua_State* L);
		static int luaDungeonGetObjectives(lua_State* L);
		static int luaDungeonGetObjectivesCount(lua_State* L);
		
		static int luaDungeonAddRewardChestPosition(lua_State* L);
		static int luaDungeonGetRewardChestPositions(lua_State* L);
		...
		static int luaDungeonInstanceAddMonster(lua_State* L);
		static int luaDungeonInstanceAddItem(lua_State* L);
		...
		static int luaDungeonInstanceGetKeyUID(lua_State* L);
		static int luaDungeonInstanceSetLives(lua_State* L);
		static int luaDungeonInstanceGetLives(lua_State* L);

		static int luaDungeonInstanceCompleteObjective(lua_State* L);
		static int luaDungeonInstanceIsObjectiveComplete(lua_State* L);
		static int luaDungeonInstanceAreAllObjectivesComplete(lua_State* L);
		static int luaDungeonInstanceGetCompletedObjectivesCount(lua_State* L);
		...
		static ScriptEnvironment scriptEnv[256];
