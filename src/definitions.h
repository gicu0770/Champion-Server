...
static constexpr auto STATUS_SERVER_NAME = "VisionOT";
static constexpr auto STATUS_SERVER_VERSION = "1.0.0";
static constexpr auto STATUS_SERVER_DEVELOPERS = "BoTeQ";
...
#define CLIENT_MAP_WIDTH 36
#define CLIENT_MAP_HEIGHT 22
