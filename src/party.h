...
class Party
{
	public:
		...
		bool kickPartyMember(Player* player);
		bool leaveParty(Player* player);
		bool getPartyInfo(Player* player);
		...
		void updatePlayerPosition(const Player* player, const Position& pos);
