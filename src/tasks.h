...
class Dispatcher : public ThreadHolder<Dispatcher> {
	public:
		...
		Dispatcher() : work(boost::asio::make_work_guard(io_context)) {}
		#else
		Dispatcher() : work(std::make_shared<boost::asio::io_context::work>(io_context)) {}
		#endif
	...
	private:
		...
		std::map<uint64_t, std::unique_ptr<boost::asio::deadline_timer>> eventIds;
