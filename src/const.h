...
static constexpr auto INSTANCE_PASSWORD = "lh&1~163(Lpasx";
...
enum item_t : uint16_t {
	...
	ITEM_INBOX = 14404,
	ITEM_MARKET = 14405,
	ITEM_TEMP_STORAGE = 1987,
	ITEM_TRADE_STORAGE = 1740,

	#if GAME_FEATURE_STORE_INBOX > 0
	ITEM_STORE_INBOX = 26052,
	#endif

	ITEM_RELICT_BOX = 21518,
...
static constexpr int32_t PSTRG_OUTFITS_RANGE_START = PSTRG_RESERVED_RANGE_START;
static constexpr int32_t PSTRG_MOUNTS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 5000);
static constexpr int32_t PSTRG_MOUNTS_CURRENTMOUNT = (PSTRG_MOUNTS_RANGE_START + 10);

static constexpr int32_t PSTRG_WINGS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 6000);
static constexpr int32_t PSTRG_AURAS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 10000);
static constexpr int32_t PSTRG_SHADERS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 15000);
static constexpr int32_t PSTRG_OUTLINE_RANGE_START = (PSTRG_RESERVED_RANGE_START + 20000);
static constexpr int32_t PSTRG_BESTIARY_RANGE_START = (PSTRG_RESERVED_RANGE_START + 25000);
