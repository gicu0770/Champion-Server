...
ScriptEnvironment LuaScriptInterface::scriptEnv[256];
...
const std::string& LuaScriptInterface::getAddEventStackTracebackHash(const std::string& addEventStackBacktrace)
{
	...
	auto* hash = new std::string(
    	"LuaAddEvent-" + std::to_string(adlerChecksum(reinterpret_cast<const uint8_t*>(addEventStackBacktrace.c_str()),
...
Outfit_t LuaScriptInterface::getOutfit(lua_State* L, int32_t arg)
{
	...
	outfit.lookOutline = getFieldString(L, arg, "lookOutline");
...
void LuaScriptInterface::pushCombatDamage(lua_State* L, const CombatDamage& damage)
{
	...
	lua_pushnumber(L, damage.uid);
	lua_pushnumber(L, damage.critChance);
}
...
void LuaScriptInterface::pushInstantSpell(lua_State* L, const InstantSpell& spell)
{
	...
	setField(L, "desc", spell.getDesc());
	setField(L, "icon", spell.getIcon());
	setField(L, "image", spell.getImage());
	setField(L, "cooldown", spell.getCooldown());
	setField(L, "power", spell.getPower());
	setField(L, "type", spell.getType());
...
void LuaScriptInterface::pushOutfit(lua_State* L, const Outfit_t& outfit)
{
	...
	setField(L, "lookOutline", outfit.lookOutline);
}
...
void LuaScriptInterface::registerFunctions()
{
	...
	//saveServerAsync([delayBetweenPlayers = 50])
	lua_register(luaState, "saveServerAsync", LuaScriptInterface::luaSaveServerAsync);

	//cleanMap()
	lua_register(luaState, "cleanMap", LuaScriptInterface::luaCleanMap);

	//debugPrint(text)
	lua_register(luaState, "dprint", LuaScriptInterface::luaDebugPrint);
	...
	registerEnum(COMBAT_PHYSICAL_PROC_DAMAGE)
	registerEnum(COMBAT_ELEMENTAL_PROC_DAMAGE)
	registerEnum(COMBAT_PHYSICAL_DOT)
	registerEnum(COMBAT_ELEMENTAL_DOT)
	...
	registerEnum(COMBAT_PARAM_TYPEOB)
	registerEnum(COMBAT_PARAM_BOTTOMEFFECT)
	registerEnum(COMBAT_PARAM_SAVEPOS)
	registerEnum(COMBAT_PARAM_COLOR)
	registerEnum(COMBAT_PARAM_DAMAGE)
	registerEnum(COMBAT_PARAM_CENTEREFFECT)
	registerEnum(COMBAT_PARAM_OFFSETXEFFECT)
	registerEnum(COMBAT_PARAM_OFFSETYEFFECT)

	registerEnum(COMBAT_PARAM_DAMAGE2)
	registerEnum(COMBAT_PARAM_TYPE2)
	...
	registerEnum(CONDITION_HARD_DRUNK)
	...
	registerEnum(CONDITIONID_GLOVES)
	registerEnum(CONDITIONID_RING2)
	registerEnum(CONDITIONID_SPELL1)
	registerEnum(CONDITIONID_SPELL2)
	registerEnum(CONDITIONID_SPELL3)
	registerEnum(CONDITIONID_SPELL4)
	registerEnum(CONDITIONID_POTION1)
	registerEnum(CONDITIONID_POTION2)
	...
	registerEnum(CONDITION_PARAM_STAT_MAXENERGYSHIELD)
	registerEnum(CONDITION_PARAM_STAT_MAXENERGYSHIELDPERCENT)
	registerEnum(CONDITION_PARAM_ENERGYGAIN)
	registerEnum(CONDITION_PARAM_ENERGYTICKS)
	registerEnum(CONDITION_PARAM_ATTACKSPEED)
	registerEnum(CONDITION_PARAM_MAXATTACKSPEED)
	registerEnum(CONDITION_PARAM_EXTRARANGEMELEE)
	registerEnum(CONDITION_PARAM_EXTRARANGERANGE)

	registerEnum(STAT_MAXHITPOINTS)
	registerEnum(STAT_MAXMANAPOINTS)
	registerEnum(STAT_MAGICPOINTS)
	registerEnum(STAT_MAXENERGYSHIELD)

	registerEnum(STAT_MAXHITPOINTSPERCENT)
	registerEnum(STAT_MAXMANAPOINTSPERCENT)
	registerEnum(STAT_MAGICPOINTSPERCENT)
	registerEnum(STAT_MAXENERGYSHIELDPERCENT)
	registerEnum(STAT_ATTACKSPEED)
	registerEnum(STAT_MAXATTACKSPEED)
	registerEnum(STAT_EXTRARANGEMELEE)
	registerEnum(STAT_EXTRARANGERANGE)
	...
	registerEnum(CONST_55)
	registerEnum(CONST_56)
	registerEnum(CONST_57)
	registerEnum(CONST_58)
	registerEnum(CONST_59)
	registerEnum(CONST_60)
	registerEnum(CONST_61)
	registerEnum(CONST_62)
	registerEnum(CONST_63)
	registerEnum(CONST_64)
	registerEnum(CONST_65)
	registerEnum(CONST_66)
	registerEnum(CONST_67)
	registerEnum(CONST_68)
	registerEnum(CONST_69)
	registerEnum(CONST_70)
	registerEnum(CONST_71)
	registerEnum(CONST_72)
	registerEnum(CONST_73)
	registerEnum(CONST_74)
	registerEnum(CONST_75)
	registerEnum(CONST_76)
	registerEnum(CONST_77)
	registerEnum(CONST_78)
	registerEnum(CONST_79)
	registerEnum(CONST_80)
	registerEnum(CONST_81)
	registerEnum(CONST_82)
	registerEnum(CONST_83)
	registerEnum(CONST_84)
	registerEnum(CONST_85)
	registerEnum(CONST_86)
	registerEnum(CONST_87)
	registerEnum(CONST_88)
	registerEnum(CONST_89)
	registerEnum(CONST_90)
	registerEnum(CONST_91)
	registerEnum(CONST_92)
	registerEnum(CONST_93)
	registerEnum(CONST_94)
	registerEnum(CONST_95)
	registerEnum(CONST_96)
	registerEnum(CONST_97)
	registerEnum(CONST_98)
	registerEnum(CONST_99)
	registerEnum(CONST_100)
	...
	registerEnum(CONST_SLOT_SPELL1)
	registerEnum(CONST_SLOT_SPELL2)
	registerEnum(CONST_SLOT_SPELL3)
	registerEnum(CONST_SLOT_SPELL4)
	registerEnum(CONST_SLOT_POTION1)
	registerEnum(CONST_SLOT_POTION2)
	registerEnum(CONST_SLOT_FORGE)
	
	registerEnum(CONST_SLOT_SUPPORT1_1)
	registerEnum(CONST_SLOT_SUPPORT1_2)
	registerEnum(CONST_SLOT_SUPPORT1_3)
	registerEnum(CONST_SLOT_SUPPORT1_4)

	registerEnum(CONST_SLOT_SUPPORT2_1)
	registerEnum(CONST_SLOT_SUPPORT2_2)
	registerEnum(CONST_SLOT_SUPPORT2_3)
	registerEnum(CONST_SLOT_SUPPORT2_4)

	registerEnum(CONST_SLOT_SUPPORT3_1)
	registerEnum(CONST_SLOT_SUPPORT3_2)
	registerEnum(CONST_SLOT_SUPPORT3_3)
	registerEnum(CONST_SLOT_SUPPORT3_4)

	registerEnum(CONST_SLOT_SUPPORT4_1)
	registerEnum(CONST_SLOT_SUPPORT4_2)
	registerEnum(CONST_SLOT_SUPPORT4_3)
	registerEnum(CONST_SLOT_SUPPORT4_4)
	registerEnum(CONST_SLOT_STORE_INBOX)
	registerEnum(CONST_SLOT_RELICT_BOX)
	...
	registerEnum(CREATURE_EVENT_ENDSCRIPTS_REGEN)
	registerEnum(CREATURE_EVENT_MINUSREGENHP)
	registerEnum(CREATURE_EVENT_HEALTHDRAIN)
	...
	registerEnum(SLOTP_SPELL1)
	registerEnum(SLOTP_SPELL2)
	registerEnum(SLOTP_SPELL3)
	registerEnum(SLOTP_SPELL4)
	registerEnum(SLOTP_POTION1)
	registerEnum(SLOTP_POTION2)

	registerEnum(SLOTP_SUPPORT1_1)
	...
	registerEnum(ORIGIN_DOT)
	registerEnum(ORIGIN_CAST)
	registerEnum(ORIGIN_REFLECT)
	registerEnum(ORIGIN_AUTOCAST)
	registerEnum(ORIGIN_ATTRIBUTE)
	...
	registerEnum(RETURNVALUE_EMPTY)
	...
	registerEnum(RETURNVALUE_SPAWNBLOCKINGTHISCREATURE)
	...
	registerEnum(RELOAD_TYPE_OUTLINES)
	...
	// DungeonCompleteType
	registerEnum(DUNGEONTYPE_KILL_PERCENT)
	registerEnum(DUNGEONTYPE_OBJECTIVES)
	...
	registerEnum(CHARSTAT_SPEED)
	registerEnum(CHARSTAT_SKILL) // skills
	registerEnum(CHARSTAT_DEXTERITY)
	registerEnum(CHARSTAT_SPIRIT)
	registerEnum(CHARSTAT_WISDOM)
	registerEnum(CHARSTAT_PERCEPTION)
	registerEnum(CHARSTAT_CRITICAL_DAMAGE)
	registerEnum(CHARSTAT_REGEN) // regen
	registerEnum(CHARSTAT_LIFE) // life leech
	registerEnum(CHARSTAT_FIRST)
	registerEnum(CHARSTAT_LAST)
	registerEnum(CHARSTAT_MOVEMENT_SPEED)
	registerEnum(CHARSTAT_ONE)
	registerEnum(CHARSTAT_TWO)
	registerEnum(CHARSTAT_HPHIT)
	registerEnum(CHARSTAT_ESHIT)
	...
	registerEnumIn("configKeys", ConfigManager::DEATH_LOSE_PERCENT_RED_SKULL)
	registerEnumIn("configKeys", ConfigManager::DEATH_LOSE_PERCENT_BLACK_SKULL)
	...
	#endif
	registerEnumIn("configKeys", ConfigManager::INSTANCE_TYPE)


	registerEnumIn("configKeys", ConfigManager::STATS_TRACK_LUA_ADD_EVENTS);
	registerEnumIn("configKeys", ConfigManager::STATS_TRACK_LUA_ADD_EVENTS_HASHES);
	registerEnumIn("configKeys", ConfigManager::STATS_DUMP_INTERVAL);
	registerEnumIn("configKeys", ConfigManager::STATS_SLOW_LOG_TIME);
	registerEnumIn("configKeys", ConfigManager::STATS_VERY_SLOW_LOG_TIME);
	...
	registerTable("InstanceManager");
	registerMethod("InstanceManager", "startInstance", LuaScriptInterface::luaInstanceManagerStartInstance);
	registerMethod("InstanceManager", "forceClose", LuaScriptInterface::luaInstanceManagerForceClose);
	...
	registerMethod("Game", "getMarketItems", LuaScriptInterface::luaGameGetMarketItems);
	
	registerMethod("Game", "getItemIdByClientId", LuaScriptInterface::luaGameGetItemIdByClientId);

	registerMethod("Game", "getMonsterTypeByBestiaryId", LuaScriptInterface::luaGameGetMonsterTypeByBestiaryId);
	registerMethod("Game", "getMonstersTypeByZoneId", LuaScriptInterface::luaGameGetMonstersTypeByZoneId);

	registerMethod("Game", "getHouseById", LuaScriptInterface::luaGameGetHouseById);

	registerMethod("Game", "scanAllPlayerItems", LuaScriptInterface::luaGameScanAllPlayerItems);
	...
	registerMethod("Position", "sendLineEffect", LuaScriptInterface::luaPositionSendLineEffect);
	registerMethod("Position", "getDirectionTo", LuaScriptInterface::luaPositionGetDirectionTo);
	...
	registerMethod("Tile", "setWidget", LuaScriptInterface::luaTileSetWidget);
	registerMethod("Tile", "removeWidget", LuaScriptInterface::luaTileRemoveWidget);
	...
	registerMethod("Item", "setCount", LuaScriptInterface::luaItemSetCount);
	registerMethod("Item", "getColor", LuaScriptInterface::luaItemGetColor);
	...
	registerMethod("Item", "getSpellName", LuaScriptInterface::luaItemGetSpellName);
	registerMethod("Item", "getPotionName", LuaScriptInterface::luaItemGetPotionName);
	registerMethod("Item", "getPotionId", LuaScriptInterface::luaItemGetPotionId);
	registerMethod("Item", "setRealUID", LuaScriptInterface::luaItemSetRealUID);

	registerMethod("Item", "updateSelf", LuaScriptInterface::luaItemUpdateSelf);

	registerMethod("Item", "isRelictBox", LuaScriptInterface::luaItemIsRelictBox);
	registerMethod("Item", "getLootIndex", LuaScriptInterface::luaItemGetLootIndex);
	...
	registerMethod("Container", "setSize", LuaScriptInterface::luaContainerSetSize);
	...
	registerMethod("Container", "getItemUID", LuaScriptInterface::luaContainerGetItemUID);
	registerMethod("Container", "getItemById", LuaScriptInterface::luaContainerGetItemById);
	...
	registerMethod("Container", "setCorpseOwner", LuaScriptInterface::luaContainerSetCorpseOwner);
	...
	registerMethod("Creature", "getMaxEnergyShield", LuaScriptInterface::luaCreatureGetMaxEnergyShield);
	registerMethod("Creature", "setMaxEnergyShield", LuaScriptInterface::luaCreatureSetMaxEnergyShield);

	registerMethod("Creature", "getTotalHealthGain", LuaScriptInterface::luaCreatureGetTotalHealthGain);
	registerMethod("Creature", "getTotalPrecentHealthGain", LuaScriptInterface::luaCreatureGetTotalPrecentHealthGain);

	registerMethod("Creature", "getTotalEnergyShieldGain", LuaScriptInterface::luaCreatureGetTotalEnergyShieldGain);
	registerMethod("Creature", "getTotalPrecentEnergyShieldGain", LuaScriptInterface::luaCreatureGetTotalPrecentEnergyShieldGain);

	registerMethod("Creature", "addHealthGain", LuaScriptInterface::luaCreatureAddHealthGain);
	registerMethod("Creature", "removeHealthGain", LuaScriptInterface::luaCreatureRemoveHealthGain);
	registerMethod("Creature", "addHealthPrecentGain", LuaScriptInterface::luaCreatureAddHealthPrecentGain);
	registerMethod("Creature", "removeHealthPrecentGain", LuaScriptInterface::luaCreatureRemoveHealthPrecentGain);

	registerMethod("Creature", "getEnergyShieldGain", LuaScriptInterface::luaCreatureGetEnergyShieldGain);
	registerMethod("Creature", "addEnergyShieldGain", LuaScriptInterface::luaCreatureAddEnergyShieldGain);
	registerMethod("Creature", "removeEnergyShieldGain", LuaScriptInterface::luaCreatureRemoveEnergyShieldGain);
	registerMethod("Creature", "addEnergyShieldPrecentGain", LuaScriptInterface::luaCreatureAddEnergyShieldPrecentGain);
	registerMethod("Creature", "removeEnergyShieldPrecentGain", LuaScriptInterface::luaCreatureRemoveEnergyShieldPrecentGain);

	registerMethod("Creature", "getEnergyShieldGainForce", LuaScriptInterface::luaCreatureGetEnergyShieldGainForce);
	registerMethod("Creature", "getEnergyShieldGainForceTotal", LuaScriptInterface::luaCreatureGetEnergyShieldGainForceTotal);
	registerMethod("Creature", "addEnergyShieldGainForce", LuaScriptInterface::luaCreatureAddEnergyShieldGainForce);
	registerMethod("Creature", "removeEnergyShieldGainForce", LuaScriptInterface::luaCreatureRemoveEnergyShieldGainForce);
	registerMethod("Creature", "addEnergyShieldPrecentGainForce", LuaScriptInterface::luaCreatureAddEnergyShieldPrecentGainForce);
	registerMethod("Creature", "getEnergyShieldPrecentGainForceTotal", LuaScriptInterface::luaCreatureGetEnergyShieldPrecentGainForceTotal);
	registerMethod("Creature", "removeEnergyShieldPrecentGainForce", LuaScriptInterface::luaCreatureRemoveEnergyShieldPrecentGainForce);
	...
	registerMethod("Creature", "setInPlace", LuaScriptInterface::luaCreatureSetInPlace);
	registerMethod("Creature", "isInPlace", LuaScriptInterface::luaCreatureIsInPlace);

	registerMethod("Creature", "addActiveAura", LuaScriptInterface::luaCreatureAddActiveAura);
	registerMethod("Creature", "removeActiveAura", LuaScriptInterface::luaCreatureRemoveActiveAura);
	registerMethod("Creature", "getActiveAuras", LuaScriptInterface::luaCreatureGetActiveAuras);

	registerMethod("Creature", "jump", LuaScriptInterface::luaCreatureJump);
	registerMethod("Creature", "setProgressBar", LuaScriptInterface::luaCreatureSetProgressBar);
	
	registerMethod("Creature", "addFear", LuaScriptInterface::luaCreatureAddFear);
	registerMethod("Creature", "removeFear", LuaScriptInterface::luaCreatureRemoveFear);
	registerMethod("Creature", "hasFear", LuaScriptInterface::luaCreatureHasFear);
	registerMethod("Creature", "targetRechable", LuaScriptInterface::luaPlayerTargetRechable);

	registerMethod("Creature", "sendCreatureEffect", LuaScriptInterface::luaCreatureSendCreatureEffect);

	registerMethod("Creature", "setTitle", LuaScriptInterface::luaCreatureSetTitle);
	registerMethod("Creature", "getTitle", LuaScriptInterface::luaCreatureGetTitle);

	registerMethod("Creature", "setFlying", LuaScriptInterface::luaCreatureSetFlying);
	registerMethod("Creature", "isFlying", LuaScriptInterface::luaCreatureIsFlying);
	...
	registerMethod("Creature", "getBestiaryId", LuaScriptInterface::luaCreatureGetBestiaryId);
	...
	registerMethod("Player", "getFirstLogin", LuaScriptInterface::luaPlayerGetFirstLogin);
	registerMethod("Player", "getOnlineTime", LuaScriptInterface::luaPlayerGetOnlineTime);
	...
	registerMethod("Player", "getTempStorage", LuaScriptInterface::luaPlayerGetTempStorage);
	registerMethod("Player", "getTradeStorage", LuaScriptInterface::luaPlayerGetTradeStorage);
	...
	registerMethod("Player", "getTotalManaGain", LuaScriptInterface::luaPlayerGetTotalManaGain);
	registerMethod("Player", "getTotalPrecentManaGain", LuaScriptInterface::luaPlayerGetTotalPrecentManaGain);
	registerMethod("Player", "addManaGain", LuaScriptInterface::luaPlayerAddManaGain);
	registerMethod("Player", "removeManaGain", LuaScriptInterface::luaPlayerRemoveManaGain);
	registerMethod("Player", "addManaPrecentGain", LuaScriptInterface::luaPlayerAddManaPrecentGain);
	registerMethod("Player", "removeManaPrecentGain", LuaScriptInterface::luaPlayerRemoveManaPrecentGain);

	registerMethod("Player", "addReservation", LuaScriptInterface::luaPlayerAddReservation);
	registerMethod("Player", "removeReservation", LuaScriptInterface::luaPlayerRemoveReservation);
	registerMethod("Player", "getRealMaxMana", LuaScriptInterface::luaPlayerGetRealMaxMana);
	registerMethod("Player", "getPrecentManaMultiplier", LuaScriptInterface::luaPlayerGetPrecentManaMultiplier);
	registerMethod("Player", "getRealMaxHealth", LuaScriptInterface::luaPlayerGetRealMaxHealth);
	registerMethod("Player", "getPrecentHealthMultiplier", LuaScriptInterface::luaPlayerGetPrecentHealthMultiplier);

	registerMethod("Player", "getPrecentEnergyShieldMultiplier", LuaScriptInterface::luaPlayerGetPrecentEnergyShieldMultiplier);
	...
	registerMethod("Player", "setShop", LuaScriptInterface::luaPlayerSetShop);
	registerMethod("Player", "isShop", LuaScriptInterface::luaPlayerGetShop);
	...
	registerMethod("Player", "removeItemUnique", LuaScriptInterface::luaPlayerRemoveItemUnique);
	...
	registerMethod("Player", "getTotalMoney", LuaScriptInterface::luaPlayerGetTotalMoney);
	registerMethod("Player", "removeTotalMoney", LuaScriptInterface::luaPlayerRemoveTotalMoney);
	...
	registerMethod("Player", "getContainerByPos", LuaScriptInterface::luaPlayerGetContainerByPos);

	registerMethod("Player", "setLimitMaxHealth", LuaScriptInterface::luaPlayerSetLimitMaxHealth);
	registerMethod("Player", "getLimitMaxHealth", LuaScriptInterface::luaPlayerGetLimitMaxHealth);
	...
	registerMethod("Player", "addOutline", LuaScriptInterface::luaPlayerAddOutline);
	registerMethod("Player", "hasOutline", LuaScriptInterface::luaPlayerHasOutline);
	...
	registerMethod("Player", "startRecording", LuaScriptInterface::luaPlayerStartRecording);
	registerMethod("Player", "stopRecording", LuaScriptInterface::luaPlayerStopRecording);
	...
	registerMethod("Player", "getPartyInfo", LuaScriptInterface::luaPlayerGetPartyInfo);

	registerMethod("Player", "spellCheck", LuaScriptInterface::luaPlayerSpellCheck);
	...
	registerMethod("Player", "logInfo", LuaScriptInterface::luaPlayerLogInfo);

	registerMethod("Player", "addItemToMarket", LuaScriptInterface::luaPlayerAddItemToMarket);
	registerMethod("Player", "cancelMarketOffer", LuaScriptInterface::luaPlayerCancelMarketOffer);
	registerMethod("Player", "buyMarketOffer", LuaScriptInterface::luaPlayerBuyMarketOffer);

	registerMethod("Player", "updateStore", LuaScriptInterface::luaPlayerUpdateStore);
	registerMethod("Player", "isShopping", LuaScriptInterface::luaPlayerIsShopping);

	registerMethod("Player", "getDungeonTier", LuaScriptInterface::luaPlayerGetDungeonTier);
	registerMethod("Player", "setDungeonTier", LuaScriptInterface::luaPlayerSetDungeonTier);

	registerMethod("Player", "getDPS", LuaScriptInterface::luaPlayerGetDPS);
	registerMethod("Player", "setDPS", LuaScriptInterface::luaPlayerSetDPS);
	...
	registerMethod("Player", "getDeaths", LuaScriptInterface::luaPlayerGetDeaths);
	registerMethod("Player", "setDeaths", LuaScriptInterface::luaPlayerSetDeaths);
	registerMethod("Player", "addDeath", LuaScriptInterface::luaPlayerAddDeath);

	registerMethod("Player", "canSpendPoints", LuaScriptInterface::luaPlayerCanSpendPoints);
	registerMethod("Player", "autoOpenContainers", LuaScriptInterface::luaPlayerAutoOpenContainers);
	...
	registerMethod("Monster", "setMonsterLevel", LuaScriptInterface::luaMonsterSetLevel);
	...
	registerMethod("Monster", "getInstance", LuaScriptInterface::luaMonsterGetInstance);
	...
	registerMethod("ItemType", "getColor", LuaScriptInterface::luaItemTypeGetColor);
	...
	registerMethod("Combat", "setParameterText", LuaScriptInterface::luaCombatSetParameterText);
	...
	registerMethod("MonsterType", "tier", LuaScriptInterface::luaMonsterTypeTier);
	registerMethod("MonsterType", "items", LuaScriptInterface::luaMonsterTypeItems);
	...
	registerMethod("MonsterType", "zoneId", LuaScriptInterface::luaMonsterTypeZoneId);
	registerMethod("MonsterType", "bestiaryId", LuaScriptInterface::luaMonsterTypeBestiaryId);
	...
	registerMethod("Spell", "desc", LuaScriptInterface::luaSpellDesc);
	registerMethod("Spell", "icon", LuaScriptInterface::luaSpellIcon);
	registerMethod("Spell", "image", LuaScriptInterface::luaSpellImage);
	registerMethod("Spell", "power", LuaScriptInterface::luaSpellPower);
	registerMethod("Spell", "type", LuaScriptInterface::luaSpellType);
	...
	registerMethod("CreatureEvent", "onEndScriptsRegen", LuaScriptInterface::luaCreatureEventOnCallback);
	registerMethod("CreatureEvent", "onMinusRegenHP", LuaScriptInterface::luaCreatureEventOnCallback);
	registerMethod("CreatureEvent", "onHealthDrain", LuaScriptInterface::luaCreatureEventOnCallback);
	...
	registerMethod("Dungeon", "setCompleteType", LuaScriptInterface::luaDungeonSetCompleteType);
	registerMethod("Dungeon", "getCompleteType", LuaScriptInterface::luaDungeonGetCompleteType);

	registerMethod("Dungeon", "setSolo", LuaScriptInterface::luaDungeonSetSolo);
	registerMethod("Dungeon", "isSolo", LuaScriptInterface::luaDungeonIsSolo);
	...
	registerMethod("Dungeon", "setRequiredParagon", LuaScriptInterface::luaDungeonSetRequiredParagon);
	registerMethod("Dungeon", "getRequiredParagon", LuaScriptInterface::luaDungeonGetRequiredParagon);
	...
	registerMethod("Dungeon", "addObjective", LuaScriptInterface::luaDungeonAddObjective);
	registerMethod("Dungeon", "getObjectives", LuaScriptInterface::luaDungeonGetObjectives);
	registerMethod("Dungeon", "getObjectivesCount", LuaScriptInterface::luaDungeonGetObjectivesCount);

	registerMethod("Dungeon", "addRewardChestPosition", LuaScriptInterface::luaDungeonAddRewardChestPosition);
	registerMethod("Dungeon", "getRewardChestPositions", LuaScriptInterface::luaDungeonGetRewardChestPositions);
	...
	registerMethod("Dungeon", "getPlayersCount", LuaScriptInterface::luaDungeonGetPlayersCount);
	...
	registerMethod("DungeonInstance", "addMonster", LuaScriptInterface::luaDungeonInstanceAddMonster);
	registerMethod("DungeonInstance", "addItem", LuaScriptInterface::luaDungeonInstanceAddItem);
	...
	registerMethod("DungeonInstance", "getKeyUID", LuaScriptInterface::luaDungeonInstanceGetKeyUID);

	registerMethod("DungeonInstance", "setLives", LuaScriptInterface::luaDungeonInstanceSetLives);
	registerMethod("DungeonInstance", "getLives", LuaScriptInterface::luaDungeonInstanceGetLives);

	registerMethod("DungeonInstance", "completeObjective", LuaScriptInterface::luaDungeonInstanceCompleteObjective);
	registerMethod("DungeonInstance", "isObjectiveComplete", LuaScriptInterface::luaDungeonInstanceIsObjectiveComplete);
	registerMethod("DungeonInstance", "areAllObjectivesComplete", LuaScriptInterface::luaDungeonInstanceAreAllObjectivesComplete);
	registerMethod("DungeonInstance", "getCompletedObjectivesCount", LuaScriptInterface::luaDungeonInstanceGetCompletedObjectivesCount);
...
int LuaScriptInterface::luaDoPlayerAddItem(lua_State* L)
{
	...
	if (parameters > 4) {
		...
		if (it.stackable) {
			itemCount = static_cast<int32_t>(std::ceil(static_cast<float>(count) / 9999));
		} else {
			itemCount = 1;
		}
		subType = count;
	...
	while (itemCount > 0) {
		...
		if (it.stackable && stackCount > 9999) {
			stackCount = 9999;
		}

		Item* newItem = Item::CreateItem(itemId, stackCount, true);
		if (!newItem) {
...
int LuaScriptInterface::luaDoAreaCombat(lua_State* L)
{
	...
	if (!creature || creature->isRemoved() && (!isNumber(L, 1) || getNumber<uint32_t>(L, 1) != 0)) {
	...
	if (cooldown > 0 && id > 0) {
		...
		Condition* condition = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_SPELLCOOLDOWN, cooldown, 0, false, id+1000);
...
int LuaScriptInterface::luaDoAddContainerItem(lua_State* L)
{
	...
	while (itemCount > 0) {
		int32_t stackCount = std::min<int32_t>(9999, subType);
		Item* newItem = Item::CreateItem(itemId, stackCount, true);
		if (!newItem) {
			reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
			pushBoolean(L, false);
...
int LuaScriptInterface::luaAddEvent(lua_State* L)
{
	...
	eventDesc.scriptId = getScriptEnv()->getScriptId();
		...
		if (g_config.getBoolean(ConfigManager::STATS_TRACK_LUA_ADD_EVENTS)) {
			auto interface = getScriptEnv()->getScriptInterface();
			std::string trackLuaAddEventLog = interface->getStackTrace("");
...
int LuaScriptInterface::luaStopEvent(lua_State* L)
{
	...
	// DIAGNOSTIC: Log event cleanup, especially for aura scripts
	size_t eventCount = timerEvents.size();
	if (eventCount % 1000 == 0 && eventCount > 0) {
		std::cout << "[LUA EVENTS] Events after cleanup: " << eventCount << std::endl;
	}
...
int LuaScriptInterface::luaSaveServerAsync(lua_State* L)
{
	// saveServerAsync([delayBetweenPlayers = 50])
	uint32_t delay = getNumber<uint32_t>(L, 1, 50);
	g_game.saveGameStateAsync(delay);
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaDatabaseAsyncExecute(lua_State* L)
{
	...
	if (parameters > 1) {
		...
		callback = [ref, scriptId, params](DBResult_ptr, bool success, uint64_t) {
...
int LuaScriptInterface::luaDatabaseAsyncStoreQuery(lua_State* L)
{
	...
	if (parameters > 1) {
		...
		int32_t ref = luaL_ref(L, LUA_REGISTRYINDEX);
		auto scriptId = getScriptEnv()->getScriptId();
		callback = [ref, scriptId, params](DBResult_ptr result, bool, uint64_t) {
			lua_State* luaState = g_luaEnvironment.getLuaState();
			if (!luaState) {
				return;
			}
...
int LuaScriptInterface::luaResultGetNumber(lua_State* L)
{
	...
	lua_pushnumber(L, res->getNumber<double>(s));
	return 1;
}
...
int LuaScriptInterface::luaInstanceManagerStartInstance(lua_State* L)
{
	Player* player = getPlayer(L, 1);
	if (!player) {
		lua_pushnil(L);
	...
	uint8_t type = getNumber<uint8_t>(L, 2, 1); // 0 is main server
	const std::string map = getString(L, 3);
	if (map.empty()) {
		lua_pushnil(L);
		return 1;
	}
	
	g_instanceManager->startInstance(player, type, map);
	return 1;
}

int LuaScriptInterface::luaInstanceManagerForceClose(lua_State* L)
{
	uint32_t id = getNumber<uint32_t>(L, 1, 0); // 0 is main server
	if (id == 0) {
		pushBoolean(L, false);
		return 1;
	}
	
	pushBoolean(L, g_instanceManager->forceCloseInstance(id));
	return 1;
}
...
int LuaScriptInterface::luaGameCreateItem(lua_State* L)
{
	...
	bool loaded = getBoolean(L, 4, true);
	Item* item = Item::CreateItem(id, count, loaded);
	if (!item) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaGameLoadMapChunk(lua_State* L)
{
	...
	g_dispatcher.addTask([path, position, unload]() {
		try {
			g_game.loadMap(path, position, unload, true);
		} catch (const std::exception& e) {
...
int LuaScriptInterface::luaGameGetMarketItems(lua_State* L)
{
	std::unordered_map<uint32_t, Item*> items = g_game.getMarketItems();
	lua_createtable(L, items.size(), 0);

	for (const auto& entry : items) {
		uint32_t marketId = entry.first;
		Item* item = entry.second;

		pushUserdata(L, item);
		setItemMetatable(L, -1, item);

		lua_pushinteger(L, marketId);
		lua_insert(L, -2);
		lua_settable(L, -3);
	}
...
{
	const ItemType& it = Item::items.getItemIdByClientId(getNumber<uint32_t>(L, 1));
	if (it.id == 0) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaGameGetMonsterTypeByBestiaryId(lua_State* L)
{
	MonsterType* monsterType = g_monsters.getMonsterTypeByBestiaryId(getNumber<uint32_t>(L, 1));
	if (monsterType) {
		pushUserdata<MonsterType>(L, monsterType);
		setMetatable(L, -1, "MonsterType");
	} else {
...
int LuaScriptInterface::luaGameGetMonstersTypeByZoneId(lua_State* L)
{
    auto zoneMonsters = g_monsters.getMonstersTypeByZoneId(getNumber<uint32_t>(L, 1));
    if (zoneMonsters) {
        lua_createtable(L, 0, zoneMonsters->size());
        for (auto& it : *zoneMonsters) {
            pushUserdata<MonsterType>(L, it.second);
            setMetatable(L, -1, "MonsterType");
...
int LuaScriptInterface::luaGameGetHouseById(lua_State* L)
{
	// Game.getHouseById(houseId)
	House* house = g_game.map.houses.getHouse(getNumber<uint32_t>(L, 1));
	if (house) {
...
int LuaScriptInterface::luaGameScanAllPlayerItems(lua_State* L)
{
	// Game.scanAllPlayerItems(threshold)
	uint32_t threshold = getNumber<uint32_t>(L, 1, 100);
	uint32_t result = g_game.scanAllPlayerItems(threshold);
...
int LuaScriptInterface::luaVariantCreate(lua_State* L)
{
	...
	LuaVariant variant;
	bool dir = getBoolean(L, 3, false);
	if (dir) {
		if (Creature* caster = getCreature(L, 2)) {
...
int LuaScriptInterface::luaPositionGetDirectionTo(lua_State* L)
{
	// position:getDirectionTo(pos1)
	const Position& pos1 = getPosition(L, 2);
	const Position& pos2 = getPosition(L, 1);
	lua_pushnumber(L, getDirectionTo(pos1, pos2));
	return 1;
}
...
int LuaScriptInterface::luaPositionSendMagicEffect(lua_State* L)
{
	...
	bool bottom = getNumber<bool>(L, 3, false);
	std::string color = getString(L, 4);
	g_game.addMagicEffect(position, magicEffect, bottom, color);
	pushBoolean(L, true);
	return 1;
}


int LuaScriptInterface::luaPositionSendLineEffect(lua_State* L)
{
	// position:sendLineEffect(positionEx, effectId[, player = nullptr])
	SpectatorVector spectators;
	if (lua_gettop(L) >= 5) {
	...
	bool bottom = getNumber<bool>(L, 4, true);
	uint16_t effectId = getNumber<uint16_t>(L, 3);
	const Position& positionEx = getPosition(L, 2);
	const Position& position = getPosition(L, 1);
	
	if (!spectators.empty()) {
		Game::addLineEffect(spectators, position, positionEx, effectId, bottom);
	} else {
		g_game.addLineEffect(position, positionEx, effectId, bottom);
	}
...
int LuaScriptInterface::luaCreatureSendCreatureEffect(lua_State* L)
{
	// creature:sendCreatureEffect(
	const Creature* creature = getCreature(L, 1);
	if (!creature || creature->isRemoved()) {
		pushBoolean(L, true);
		return 1;
	}
	...
	MagicEffectClasses magicEffect = getNumber<MagicEffectClasses>(L, 2);
	bool bottom = getNumber<bool>(L, 3, false);
	g_game.addCreatureEffect(creature, magicEffect, bottom);
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaPositionSendDistanceEffect(lua_State* L)
{
	...
	SpectatorVector spectators;
	if (lua_gettop(L) >= 8) {
		Player* player = getPlayer(L, 8);
		if (player) {
			spectators.emplace_back(player);
		}
	}

	const std::string hexColor = getString(L, 7);
	double speed = getNumber<double>(L, 6, 0.0);
	uint16_t duration = getNumber<uint16_t>(L, 5, 0);
	bool type = getBoolean(L, 4, false);
	uint16_t distanceEffect = getNumber<uint16_t>(L, 3);
	const Position& positionEx = getPosition(L, 2);
	const Position& position = getPosition(L, 1);
	if (!spectators.empty()) {
		Game::addDistanceEffect(spectators, position, positionEx, distanceEffect, type, duration, speed, hexColor);
	} else {
		g_game.addDistanceEffect(position, positionEx, distanceEffect, type, duration, speed, hexColor);
	}
...
// Tile
int LuaScriptInterface::luaTileSetWidget(lua_State * L)
{
    // tile:setWidget(id, data)
    ...
    TileWidget& widget = tile->getWidget();
    widget.id = getNumber<uint8_t>(L, 2);
	widget.data.clear();
     
    lua_pushnil(L);
    while (lua_next(L, -2) != 0) {
        widget.data.emplace_back(getString(L, -1));
        lua_pop(L, 1);
    }
    lua_pop(L, 1);
...
int LuaScriptInterface::luaTileRemoveWidget(lua_State* L)
{
	// tile:removeWidget()
	Tile* tile = getUserdata<Tile>(L, 1);
	    if (!tile) {
...
int LuaScriptInterface::luaTileAddItem(lua_State* L)
{
	...
	Item* item = Item::CreateItem(itemId, std::min<uint32_t>(subType, 100), true);
	if (!item) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaItemRemove(lua_State* L)
{
	...
	if (!item->getIsRealItem()) {
		// For non-real items (e.g., market items created for display only),
		// delete them directly since they're not in the game world
		delete item;
		pushBoolean(L, true);
		return 1;
	}
...
int LuaScriptInterface::luaItemSetCount(lua_State* L)
{
	// item:setCount(count)
	...
	if (!item->isStackable()) {
		reportErrorFunc("Item is not stackable");
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaItemGetColor(lua_State* L)
{
	// item:getColor()
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
	...
	lua_pushnumber(L, item->getColor());
	return 1;
}
...
int LuaScriptInterface::luaItemMoveTo(lua_State* L)
{
	...
	if (toPlayer) {
		...
		if (player->getThing(CONST_SLOT_BACKPACK)) {
			toCylinder = player->getThing(CONST_SLOT_BACKPACK)->getContainer();
		}
	}
	...
	uint32_t flags = getNumber<uint32_t>(L, 4);
	...
	if (item->getParent() == VirtualCylinder::virtualCylinder) {
		...
		int8_t count = getNumber<int32_t>(L, 3);
		if (count < 1) {
			count = item->getItemCount();
		}

		ReturnValue ret = g_game.internalMoveItem(item->getParent(), toCylinder, INDEX_WHEREEVER, item, count, &moveItem, flags, nullptr, true);
		if (moveItem) {
			*itemPtr = moveItem;
		}
...
int LuaScriptInterface::luaItemGetSpellName(lua_State* L)
{
	// item:getSpellName()
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
	...
	pushString(L, item->getSpellName());
	return 1;
}

int LuaScriptInterface::luaItemGetPotionName(lua_State* L)
{
	// item:getPotionName()
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
	...
	pushString(L, item->getPotionName());
	return 1;
}

int LuaScriptInterface::luaItemGetPotionId(lua_State* L)
{
	// item:getPotionId()
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
	...
	lua_pushnumber(L, item->getPotionId());
	return 1;
}

int LuaScriptInterface::luaItemIsRelictBox(lua_State* L)
{
	// item:isRelictBox()
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
	...
	lua_pushboolean(L, item->isRelictBox());
	return 1;
}

int LuaScriptInterface::luaItemGetLootIndex(lua_State* L)
{
	// item:isRelictBox()
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
	...
	lua_pushnumber(L, item->getLootIndex());
	return 1;
}

int LuaScriptInterface::luaItemSetRealUID(lua_State* L)
{
	// item:setRealUID(uid)
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
...
int LuaScriptInterface::luaItemUpdateSelf(lua_State* L)
{
	// item:setRealUID(uid)
	Item* item = getUserdata<Item>(L, 1);
	if (!item || !item->getIsRealItem()) {
...
int LuaScriptInterface::luaContainerSetSize(lua_State* L)
{
	// container:setSize()
	Container* container = getUserdata<Container>(L, 1);
	Item* item = getUserdata<Item>(L, 1);
	...
	if (container && item) {
		uint32_t size = getNumber<uint32_t>(L, 2);
		container->setMaxSize(size);
...
int LuaScriptInterface::luaContainerGetItemUID(lua_State* L)
{
	// container:getItem(index)
	Container* container = getUserdata<Container>(L, 1);
	if (!container) {
	...
	uint32_t UID = getNumber<uint32_t>(L, 2);
	Item* item = container->getItemByUID(UID);
	if (item) {
		pushUserdata<Item>(L, item);
		setItemMetatable(L, -1, item);
	} else {
...
int LuaScriptInterface::luaContainerGetItemById(lua_State* L)
{
	// container:getItemById(id)
	Container* container = getUserdata<Container>(L, 1);
	if (!container) {
		lua_pushnil(L);
		return 1;
	...
	uint32_t id = getNumber<uint32_t>(L, 2);
	Item* item = container->getItemById(id);
	if (item) {
		pushUserdata<Item>(L, item);
		setItemMetatable(L, -1, item);
	} else {
...
int LuaScriptInterface::luaContainerAddItem(lua_State* L)
{
	...
	Item* item = Item::CreateItem(itemId, count, true);
	if (!item) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaContainerSetCorpseOwner(lua_State* L)
{
	// container:setCorpseOwner(cid)
	Container* container = getUserdata<Container>(L, 1);
	if (container) {
		container->setCorpseOwner(getNumber<uint32_t>(L, 2));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaContainerGetContentDescription(lua_State* L)
{
	...
	Container* container = getUserdata<Container>(L, 1);
	if (container) {
		pushString(L, container->getContentDescription(getBoolean(L, 2)));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureCreate(lua_State* L)
{
	...
	if (isNumber(L, 2)) {
		...
		reportErrorFunc("Creature userdata is not supported");
	}
...
int LuaScriptInterface::luaCreatureCanSeeCreature(lua_State* L)
{
	...
	if (creature && !creature->isRemoved()) {
		...
		if (otherCreature || !otherCreature->isRemoved()) {
...
int LuaScriptInterface::luaCreatureSetFollowCreature(lua_State* L)
{
	...
	if (creature && !creature->isRemoved()) {
		...
		if (!followCreature || followCreature->isRemoved()) {
			lua_pushnil(L);
			return 1;
		}
...
int LuaScriptInterface::luaCreatureSetHealth(lua_State* L)
{
	...
	creature->health = std::min<int64_t>(getNumber<uint64_t>(L, 2), creature->getMaxHealth());
...
int LuaScriptInterface::luaCreatureGetEnergyShield(lua_State* L)
{
	// creature:getEnergyShield()
	const Creature* creature = getUserdata<const Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		lua_pushnumber(L, creature->getEnergyShield());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureSetEnergyShield(lua_State* L)
{
	// creature:setEnergyShield(energyShield)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->setEnergyShield(std::min<int64_t>(getNumber<int64_t>(L, 2), creature->getMaxEnergyShield()));
	g_game.addCreatureHealth(creature);
...
int LuaScriptInterface::luaCreatureAddEnergyShield(lua_State* L)
{
...
int LuaScriptInterface::luaCreatureAddHealth(lua_State* L)
{
	...
	int64_t hpChange = getNumber<int64_t>(L, 2);
	if (hpChange < 0) {
		if (creature->canDrainHealth(hpChange)) {
			creature->changeHealth(hpChange);
			pushBoolean(L, true);
			return 1;
		}
	} else {
		CombatDamage damage;
		damage.primary.value = hpChange;
		damage.origin = ORIGIN_NONE;
		damage.primary.type = COMBAT_HEALING;
		pushBoolean(L, g_game.combatChangeHealth(creature, creature, damage));
		return 1;
	}
	pushBoolean(L, false);
	return 1;
...
int LuaScriptInterface::luaCreatureGetMaxHealth(lua_State* L)
{
	...
	lua_pushnumber(L, creature->getRealMaxHealth());
	return 1;
}
...
int LuaScriptInterface::luaCreatureGetMaxEnergyShield(lua_State* L)
{
	// creature:getMaxHealth()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	lua_pushnumber(L, creature->getMaxEnergyShield());
	return 1;
}

int LuaScriptInterface::luaCreatureSetMaxEnergyShield(lua_State* L)
{
	// creature:setMaxHealth(maxHealth)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	creature->setMaxEnergyShield(getNumber<int64_t>(L, 2));
	creature->setEnergyShield(std::min<int64_t>(creature->getEnergyShield(), creature->getMaxEnergyShield()));
	g_game.addCreatureHealth(creature);
...
int LuaScriptInterface::luaCreatureGetTotalHealthGain(lua_State* L)
{
	// creature:getHealthGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, creature->getTotalHealthGain());
	return 1;
}

int LuaScriptInterface::luaCreatureGetTotalPrecentHealthGain(lua_State* L)
{
	// creature:getHealthGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	lua_pushnumber(L, creature->getTotalPrecentHealthGain());
	return 1;
}

int LuaScriptInterface::luaCreatureGetTotalEnergyShieldGain(lua_State* L)
{
	// creature:getEnergyShieldGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, creature->getTotalEnergyShieldGain());
	return 1;
}

int LuaScriptInterface::luaCreatureGetTotalPrecentEnergyShieldGain(lua_State* L)
{
	// creature:getEnergyShieldGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	lua_pushnumber(L, creature->getTotalPrecentEnergyShieldGain());
	return 1;
}

int LuaScriptInterface::luaCreatureAddHealthGain(lua_State* L)
{
	// creature:setHealthGain(healthGain)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->addHealthGain(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveHealthGain(lua_State* L)
{
	// creature:removeHealthGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->removeHealthGain(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureAddHealthPrecentGain(lua_State* L)
{
	// creature:addHealthPrecentGain(healthGain)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->addHealthPrecentGain(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveHealthPrecentGain(lua_State* L)
{
	// creature:removeHealthPrecentGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->removeHealthPrecentGain(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureGetEnergyShieldGain(lua_State* L)
{
	// creature:getEnergyShieldGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	lua_pushnumber(L, creature->getEnergyShieldTotalGain());
	return 1;
}

int LuaScriptInterface::luaCreatureAddEnergyShieldGain(lua_State* L)
{
	// creature:setEnergyShieldGain(energyShieldGain)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->addEnergyShieldGain(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveEnergyShieldGain(lua_State* L)
{
	// creature:removeEnergyShieldGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->removeEnergyShieldGain(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureAddEnergyShieldPrecentGain(lua_State* L)
{
	// creature:addEnergyShieldPrecentGain(energyShieldGain)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->addEnergyShieldPrecentGain(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveEnergyShieldPrecentGain(lua_State* L)
{
	// creature:removeEnergyShieldPrecentGain()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->removeEnergyShieldPrecentGain(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
	pushBoolean(L, true);
	return 1;
}


int LuaScriptInterface::luaCreatureGetEnergyShieldGainForce(lua_State* L)
{
	// creature:getEnergyShieldGainForce()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, creature->getEnergyShieldGainForce(getNumber<uint32_t>(L, 2)));
	return 1;
}

int LuaScriptInterface::luaCreatureGetEnergyShieldGainForceTotal(lua_State* L)
{
	// creature:getEnergyShieldGainForce()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	lua_pushnumber(L, creature->getEnergyShieldGainForceTotal());
	return 1;
}

int LuaScriptInterface::luaCreatureGetEnergyShieldPrecentGainForceTotal(lua_State* L)
{
	// creature:getEnergyShieldPrecentGainForceTotal()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, creature->getEnergyShieldPrecentGainForceTotal());
	return 1;
}

int LuaScriptInterface::luaCreatureAddEnergyShieldGainForce(lua_State* L)
{
	// creature:setEnergyShieldGainForce(energyShieldGain)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->addEnergyShieldGainForce(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveEnergyShieldGainForce(lua_State* L)
{
	// creature:removeEnergyShieldGainForce()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->removeEnergyShieldGainForce(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureAddEnergyShieldPrecentGainForce(lua_State* L)
{
	// creature:addEnergyShieldPrecentGainForce(energyShieldGain)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->addEnergyShieldPrecentGainForce(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveEnergyShieldPrecentGainForce(lua_State* L)
{
	// creature:removeEnergyShieldPrecentGainForce()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	creature->removeEnergyShieldPrecentGainForce(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaCreatureAddCondition(lua_State* L)
{
	...
	if (!creature || !condition || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaCreatureGetPathTo(lua_State* L)
{
	...
	fpp.ignoreDiagonalCost = getBoolean(L, 8, fpp.ignoreDiagonalCost);
...
int LuaScriptInterface::luaCreatureMove(lua_State* L)
{
	...
	if (isNumber(L, 2)) {
		...
		lua_pushnumber(L, g_game.internalMoveCreature(creature, direction, getNumber<uint32_t>(L, 3, 0)));
	} else {
...
int LuaScriptInterface::luaCreatureIsInPlace(lua_State* L)
{
	// creature:isInPlace()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	pushBoolean(L, creature->isInPlace());
	return 1;
}

int LuaScriptInterface::luaCreatureSetInPlace(lua_State* L)
{
	// creature:setInPlace(bool)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	}
	creature->setInPlace(getBoolean(L, 2));
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetFirstLogin(lua_State* L)
{
	// player:getFirstLogin()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getFirstLogin());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetOnlineTime(lua_State* L)
{
	// player:getOnlineTime()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getOnlineTime());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetTempStorage(lua_State* L)
{
	// player:getTempStorage()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	pushUserdata<Container>(L, storage);
	setMetatable(L, -1, "Container");
	return 1;
}

int LuaScriptInterface::luaPlayerGetTradeStorage(lua_State* L)
{
	// player:getTradeStorage()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	Container* storage = player->getTradeStorage();
	if (!storage) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaPlayerRemoveExperience(lua_State* L)
{
	...
	if (player) {
		int64_t experience = getNumber<int64_t>(L, 2);
		bool sendText = getBoolean(L, 3, false);
		bool canRemoveLevel = getBoolean(L, 4, true);
		player->removeExperience(experience, sendText, canRemoveLevel);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerSetLevel(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setLevel(getNumber<uint32_t>(L, 2));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetRealMaxMana(lua_State* L)
{
	// player:getRealMaxMana()
	const Player* player = getUserdata<const Player>(L, 1);
	if (!player || player->isRemoved()) {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetPrecentManaMultiplier(lua_State* L)
{
	// player:getPrecentManaMultiplier()
	const Player* player = getUserdata<const Player>(L, 1);
	if (!player || player->isRemoved()) {
		lua_pushnil(L);
	}
	lua_pushnumber(L, player->getPrecentManaMultiplier());
	return 1;
}

int LuaScriptInterface::luaPlayerGetPrecentHealthMultiplier(lua_State* L)
{
	// player:getPrecentHealthMultiplier()
	const Player* player = getUserdata<const Player>(L, 1);
	if (!player || player->isRemoved()) {
		lua_pushnil(L);
	}
	lua_pushnumber(L, player->getPrecentHealthMultiplier());
	return 1;
}

int LuaScriptInterface::luaPlayerGetPrecentEnergyShieldMultiplier(lua_State* L)
{
	// player:getPrecentEnergyShieldMultiplier()
	const Player* player = getUserdata<const Player>(L, 1);
	if (!player || player->isRemoved()) {
		lua_pushnil(L);
	}
	lua_pushnumber(L, player->getPrecentEnergyShieldMultiplier());
	return 1;
}

int LuaScriptInterface::luaPlayerGetRealMaxHealth(lua_State* L)
{
	// player:getRealMaxHealth()
	const Player* player = getUserdata<const Player>(L, 1);
	if (!player || player->isRemoved()) {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerAddMana(lua_State* L)
{
	...
	if (!animationOnLoss && manaChange < 0) {
		if (player->canDrainMana(manaChange)) {
		...
		damage.origin = ORIGIN_NONE;
		pushBoolean(L, g_game.combatChangeMana(player, player, damage));
		return 1;
	}
	pushBoolean(L, false);
	return 1;
...
int LuaScriptInterface::luaPlayerGetMaxMana(lua_State* L)
{
	...
	lua_pushnumber(L, player->getRealMaxMana());
	return 1;
}
...
int LuaScriptInterface::luaPlayerAddReservation(lua_State* L)
{
	Player* player = getPlayer(L, 1);
	if (player) {
		uint8_t id = getNumber<uint8_t>(L, 2);
		float reservation = getNumber<float>(L, 3);
		bool health = getBoolean(L, 4, false);
		player->addReservation(id, reservation, health);
...
int LuaScriptInterface::luaPlayerRemoveReservation(lua_State* L)
{
	Player* player = getPlayer(L, 1);
	if (player) {
		uint8_t id = getNumber<uint8_t>(L, 2);
		player->removeReservation(id);
		player->sendStats(1);
		player->sendStats(4);
		pushBoolean(L, true);
	} else {
...
int LuaScriptInterface::luaPlayerGetTotalManaGain(lua_State* L)
{
	// player:getManaGain()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getTotalManaGain());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetTotalPrecentManaGain(lua_State* L)
{
	// player:getManaPrecentGain()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getTotalPrecentManaGain());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerAddManaGain(lua_State* L)
{
	// player:addManaGain(amount)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->addManaGain(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerRemoveManaGain(lua_State* L)
{
	// player:removeManaGain(id)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->removeManaGain(getNumber<uint32_t>(L, 2), getBoolean(L, 3, false));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerAddManaPrecentGain(lua_State* L)
{
	// player:addManaPrecent(amount)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->addManaPrecentGain(getNumber<uint32_t>(L, 2), getNumber<int32_t>(L, 3), getBoolean(L, 4, false));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerRemoveManaPrecentGain(lua_State* L)
{
	// player:removeManaPrecent(id)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->removeManaPrecentGain(getNumber<uint32_t>(L, 2), getBoolean(L, 2, false));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetShop(lua_State* L)
{
	// player:isShop()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		pushBoolean(L, player->isShop());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetShop(lua_State* L)
{
	// player:setShop(shop)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->setShop(getBoolean(L, 2));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerOpenMarket(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		g_game.marketOffers(player, 1, 0, 0, 0, "", 0, 0, 0);
		pushBoolean(L, true);
	}
	else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerAddItemToMarket(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	uint8_t currency = getNumber<uint8_t>(L, 4);
	uint8_t itemType = getNumber<uint8_t>(L, 5);
	double price = getNumber<double>(L, 6);
	const uint32_t marketId = g_game.nextMarketId();
	g_game.addItemToMarket(player, item, count, itemType, currency, price, marketId);

	lua_pushnumber(L, marketId);
	return 1;
}

int LuaScriptInterface::luaPlayerBuyMarketOffer(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	uint32_t marketId = getNumber<uint16_t>(L, 2);
	uint32_t amount = getNumber<uint16_t>(L, 3, 1);
	
	g_game.buyMarketOffer(player, marketId, amount);
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPlayerUpdateStore(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
...
int LuaScriptInterface::luaPlayerIsShopping(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	pushBoolean(L, player->isShopping());
	return 1;
}

int LuaScriptInterface::luaPlayerGetDungeonTier(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
	...
	lua_pushnumber(L, player->getDungeonTier());
	return 1;
}

int LuaScriptInterface::luaPlayerSetDungeonTier(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	uint16_t tier = getNumber<uint16_t>(L, 2);
	player->setDungeonTier(tier);
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPlayerGetDPS(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
	...
	lua_pushnumber(L, player->getDPS());
	return 1;
}

int LuaScriptInterface::luaPlayerSetDPS(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	uint64_t dps = getNumber<uint64_t>(L, 2);
	player->setDPS(dps);
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetKills(lua_State* L)
{
	...
	lua_pushnumber(L, player->getKills());
	return 1;
}
...
int LuaScriptInterface::luaPlayerSetKills(lua_State* L)
{
	...
	uint32_t kills = getNumber<uint32_t>(L, 2);
	player->setKills(kills);
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetDeaths(lua_State* L)
{
	// player:getDeaths()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
...
int LuaScriptInterface::luaPlayerSetDeaths(lua_State* L)
{
	...
	uint32_t deaths = getNumber<uint32_t>(L, 2);
	player->setDeaths(deaths);
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaPlayerCanSpendPoints(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
...
int LuaScriptInterface::luaPlayerAutoOpenContainers(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
...
int LuaScriptInterface::luaPlayerCancelMarketOffer(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	uint32_t marketId = getNumber<uint32_t>(L, 2);
	g_game.cancelMarketOffer(player, marketId);
...
int LuaScriptInterface::luaPlayerAddItem(lua_State* L)
{
	...
	int32_t itemCount = 1;
	int32_t desiredCount = std::max<int32_t>(1, count);

	if (it.stackable) {
		desiredCount = std::min<int32_t>(desiredCount, 9999);
		itemCount = 1;
		subType = desiredCount;
	} else {
		desiredCount = std::min<int32_t>(desiredCount, 10);
		itemCount = std::max<int32_t>(1, desiredCount);
	}
	...
	bool canDropOnMap = getBoolean(L, 4, true);
	slots_t slot = getNumber<slots_t>(L, 6, CONST_SLOT_BACKPACK);
	for (int32_t i = 1; i <= itemCount; ++i) {
		int32_t stackCount = subType;
		if (it.stackable) {
			stackCount = std::min<int32_t>(stackCount, 9999);
			subType -= stackCount;
		}

		Item* item = Item::CreateItem(itemId, stackCount, true);
		if (!item) {
			if (!hasTable) {
				lua_pushnil(L);
			}
...
int LuaScriptInterface::luaPlayerRemoveItemUnique(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		pushBoolean(L, false);
	...
	uint64_t realUID = getNumber<uint64_t>(L, 2);
	if (realUID == 0) {
		pushBoolean(L, false);
		return 1;
	}

	Item* item = player->getItemByUID(realUID);
	if (item) {
		int32_t count = getNumber<int32_t>(L, 2, -1);
		pushBoolean(L, g_game.internalRemoveItem(item, count) == RETURNVALUE_NOERROR);
	} else {
...
int LuaScriptInterface::luaPlayerRemoveTotalMoney(lua_State* L)
{
	// player:removeTotalMoney(money)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		uint64_t money = getNumber<uint64_t>(L, 2);
		pushBoolean(L, player->removeTotalMoney(money));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetTotalMoney(lua_State* L)
{
	// player:getTotalMoney()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getTotalMoney());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerShowTextDialog(lua_State* L)
{
	...
	if (isNumber(L, 2)) {
		item = Item::CreateItem(getNumber<uint16_t>(L, 2), 1, true);
		fixMemoryLeak = true;
	} else if (isString(L, 2)) {
		item = Item::CreateItem(Item::items.getItemIdByName(getString(L, 2)), 1, true);
		fixMemoryLeak = true;
	} else if (isUserdata(L, 2)) {
		if (getUserdataType(L, 2) != LuaData_Item) {
			pushBoolean(L, false);
...
int LuaScriptInterface::luaPlayerAddOutfit(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		pushBoolean(L, player->addOutfit(getNumber<uint16_t>(L, 2), 0));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerAddOutfitAddon(lua_State* L)
{
	...
	if (player) {
		...
		pushBoolean(L, player->addOutfit(lookType, addon));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetContainerByPos(lua_State* L)
{
	// player:hasOutfit(lookType[, addon = 0])
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
	...
	const Position& position = getPosition(L, 2);
	Cylinder* toCylinder = g_game.internalGetCylinder(player, position);
	if (!toCylinder) {
...
int LuaScriptInterface::luaPlayerSetLimitMaxHealth(lua_State* L)
{
	// player:setLimitMaxHealth(limitMaxHealth)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	uint32_t limitMaxHealth = getNumber<uint32_t>(L, 2);
	player->setLimitMaxHealth(limitMaxHealth);
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPlayerGetLimitMaxHealth(lua_State* L)
{
	// player:getLimitMaxHealth()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, player->getLimitMaxHealth());
	return 1;
}
...
int LuaScriptInterface::luaPlayerHasOutline(lua_State* L) {
	const Player* player = getUserdata<const Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	if (isNumber(L, 2)) {
		outline = g_game.outlines.getOutlineByID(getNumber<uint8_t>(L, 2));
	} else {
		outline = g_game.outlines.getOutlineByName(getString(L, 2));
	}

	if (outline) {
		pushBoolean(L, player->hasOutline(outline));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerAddOutline(lua_State* L) {
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	uint8_t outlineId;
	if (isNumber(L, 2)) {
		outlineId = getNumber<uint8_t>(L, 2);
	} else {
		Outline* outline = g_game.outlines.getOutlineByName(getString(L, 2));
		if (!outline) {
			lua_pushnil(L);
			return 1;
		}
	...
	pushBoolean(L, player->addOutline(outlineId));
	return 1;
}
...
int LuaScriptInterface::luaPlayerAddWings(lua_State* L) {
	// player:addWings(wingsId or wingsName)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
...
int LuaScriptInterface::luaPlayerGetPartyInfo(lua_State* L)
{
	// player:getItem(position)
	// player:getItem(realuid)
	Player* player = getUserdata<Player>(L, 1);
	...
	if (player->getParty()) {
		player->getParty()->getPartyInfo(player);
	}

	return 1;
}

int LuaScriptInterface::luaPlayerTargetRechable(lua_State* L)
{
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
	...
	uint8_t range = getNumber<uint8_t>(L, 3, -1);
	bool sendTextMessage = getBoolean(L, 4, true);

	const Position fromPos = creature->getPosition();
	const Position toPos = getPosition(L, 2);
	if (fromPos.z != toPos.z || (range == -1 && !g_game.canThrowObjectTo(fromPos, toPos, SightLine_CheckSightLineAndFloor)) || (range != -1 && !g_game.canThrowObjectTo(fromPos, toPos, SightLine_CheckSightLineAndFloor, range, range))) {
		if (sendTextMessage) {
...
int LuaScriptInterface::luaPlayerSpellCheck(lua_State* L)
{
	// player:spellCheck()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
	...
	bool aggressive, lifeTap, needTarget;
	uint16_t spellId;
	int64_t manaCost;
	uint8_t range;
	float reservation;
	...
	if (lua_isnil(L, -1) == 1) {
		...
		manaCost = getNumber<int64_t>(L, -1);
	}

	lua_getfield(L, 2, "aggressive");
	if (lua_isnil(L, -1) == 1) {
		aggressive = true;
	} else {
		aggressive = getBoolean(L, -1);
	}

	lua_getfield(L, 2, "spellId");
	if (lua_isnil(L, -1) == 1) {
		spellId = 0;
	} else {
		spellId = getNumber<uint16_t>(L, -1);
	}
	...
	if (lua_isnil(L, -1) == 1) {
		...
		range = getNumber<uint8_t>(L, -1);
	}

	lua_getfield(L, 2, "lifeTap");
	if (lua_isnil(L, -1) == 1) {
		lifeTap = false;
	} else {
		lifeTap = getBoolean(L, -1);
	}

	lua_getfield(L, 2, "manaReservation");
	if (lua_isnil(L, -1) == 1) {
		reservation = 0.00f;
	} else {
		reservation = getNumber<float>(L, -1);
	}
	lua_getfield(L, 2, "needTarget");
	if (lua_isnil(L, -1) == 1) {
		needTarget = false;
	} else {
		needTarget = getBoolean(L, -1);
	}

	if (needTarget && !player->getAttackedCreature()) {
		player->sendCancelMessage("You need a target to cast this spell.");
		pushBoolean(L, false);
		return 1;
	}
	...
	if (player->hasCondition(CONDITION_SPELLGROUPCOOLDOWN, 1) && !force) {
		pushBoolean(L, false);
		return 1;
	}
	...
	if (reservation > 0.00f) {
		float totalReserv = player->getReservation(lifeTap) - reservation;
		if (totalReserv < 0.00f || lifeTap && totalReserv <= 0.00f) {
			if (lifeTap) {
				player->sendCancelMessage("You do not have enough health.");
			} else {
		...
		if (lifeTap) {
			if (player->getHealth() <= manaCost && !player->hasFlag(PlayerFlag_HasInfiniteMana)) {
				player->sendCancelMessage(RETURNVALUE_NOTENOUGHMANA);
				pushBoolean(L, false);
				return 1;
			}
			...
			if (player->getMana() < manaCost && !player->hasFlag(PlayerFlag_HasInfiniteMana)) {
				player->sendCancelMessage(RETURNVALUE_NOTENOUGHMANA);
				pushBoolean(L, false);
				return 1;
			}
...
int LuaScriptInterface::luaPlayerIsRecording(lua_State* L)
{
	// player:isRecording()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaPlayerStartRecording(lua_State* L)
{
	// player:startRecording()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->startCamRecording();
		lua_pushboolean(L, player->isRecording());
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerStopRecording(lua_State* L)
{
	// player:stopRecording()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->stopCamRecording();
		lua_pushboolean(L, player->isRecording());
	} else {
		lua_pushnil(L);
	}
...
{
	// player:getVarStat(stat) // stats_t
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaPlayerLogInfo(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
...
{
	// monster:setMonsterLevel(number
...
int LuaScriptInterface::luaCreatureGetTargetingPlayers(lua_State* L)
{
	// creature:getTargetingPlayers()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushnil(L);
		return 1;
	...
	const auto& targetList = creature->getTargetingPlayers();
...
int LuaScriptInterface::luaMonsterGetInstance(lua_State* L)
{
	Monster* monster = getUserdata<Monster>(L, 1);
	if (monster && !monster->isRemoved()) {
		DungeonInstance* instance = monster->getInstance();
		if (instance) {
...
int LuaScriptInterface::luaVocationGetRequiredManaSpent(lua_State* L)
{
	...
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		uint32_t magicLevel = getNumber<uint64_t>(L, 2);
...
int LuaScriptInterface::luaSetCreatureName(lua_State* L)
{
    ...
    if (creature && !creature->isRemoved()) {
		...
		SpectatorVector spectators;
		g_game.map.getSpectators(spectators, monster->getPosition(), true, true);
		for (Creature* spectator : spectators) {
			if (Player* tmpPlayer = spectator->getPlayer()) {
				tmpPlayer->sendUpdateTileCreature(monster);
			}
		}
    }
    else {
...
int LuaScriptInterface::luaItemTypeGetColor(lua_State* L)
{
	// itemType:getColor()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->color);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetShootType(lua_State* L)
{
	...
	auto& shootType = itemType->shootType;
	if (shootType) {
		lua_pushnumber(L, shootType);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCombatSetParameterText(lua_State* L)
{
	// combat:setParameterText(key, value)
	Combat* combat = getUserdata<Combat>(L, 1);
	if (!combat) {
		lua_pushnil(L);
		return 1;
...
int LuaScriptInterface::luaCombatExecute(lua_State* L)
{
	...
	int8_t multipleCast = getNumber<int8_t>(L, 4, 0);
	int16_t critChance = getNumber<int16_t>(L, 5, 0);
	int16_t critMultip = getNumber<int16_t>(L, 6, 0);
	bool gambler = getBoolean(L, 7, false);
	uint32_t uid = getNumber<uint32_t>(L, 8, 0);
	...
	switch (variant.type) {
		case VARIANT_NUMBER: {
			...
			if (combat->hasArea()) {
				combat->doCombat(creature, target->getPosition(), multipleCast, critChance, critMultip, gambler, uid);
			} else {
				combat->doCombat(creature, target, multipleCast, critChance, critMultip, gambler, uid);
			}
			break;
		}
		...
		case VARIANT_POSITION: {
			...
			if (variant.directionalArea) {
				...
				combat->doCombat(creature, variant.pos, multipleCast, critChance, critMultip, gambler, uid);
...
int LuaScriptInterface::luaConditionSetOutfit(lua_State* L)
{
	...
	// condition:setOutfit(lookTypeEx, lookType, lookHead, lookBody, lookLegs, lookFeet[, lookAddons[, lookMount, lookWings, lookAura[, lookMountHead[, lookMountBody[, lookMountLegs[, lookMountFeet]]]]]])
	// condition:setOutfit(lookTypeEx, lookType, lookHead, lookBody, lookLegs, lookFeet[, lookAddons[, lookMount, [lookWings, [lookAura, [lookHealthBar, [lookManaBar]]]]]]])
	Outfit_t outfit;
	if (isTable(L, 2)) {
...
int LuaScriptInterface::luaConditionAddDamage(lua_State* L)
{
	...
	int32_t value = getNumber<int64_t>(L, 4);
	int32_t time = getNumber<int64_t>(L, 3);
	int32_t rounds = getNumber<int64_t>(L, 2);
...
int LuaScriptInterface::luaMonsterTypeZoneId(lua_State* L)
{
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.zoneId);
		} else {
			monsterType->info.zoneId = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMonsterTypeBestiaryId(lua_State* L)
{
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.bestiaryId);
		} else {
			monsterType->info.bestiaryId = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMonsterTypeTier(lua_State* L)
{
	// get: monsterType:tier() set: monsterType:tier(desc)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.tier);
		} else {
			monsterType->info.tier = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMonsterTypeItems(lua_State* L)
{
	// get: monsterType:items() set: monsterType:items(desc)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushString(L, monsterType->info.items);
		} else {
			monsterType->info.items = std::move(getString(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			...
			if (!tfs_strcmp(immunity.c_str(), "physical")) {
				...
				pushBoolean(L, true);
			} else if (!tfs_strcmp(immunity.c_str(), "physicalproc")) {
				monsterType->info.damageImmunities |= COMBAT_PHYSICAL_PROC_DAMAGE;
				pushBoolean(L, true);
			} else if (!tfs_strcmp(immunity.c_str(), "elementalproc")) {
				monsterType->info.damageImmunities |= COMBAT_ELEMENTAL_PROC_DAMAGE;
				pushBoolean(L, true);
			} else if (!tfs_strcmp(immunity.c_str(), "physicaldot")) {
				monsterType->info.damageImmunities |= COMBAT_PHYSICAL_DOT;
				pushBoolean(L, true);
			} else if (!tfs_strcmp(immunity.c_str(), "elementaldot")) {
				monsterType->info.damageImmunities |= COMBAT_ELEMENTAL_DOT;
				pushBoolean(L, true);
			} else {
...
int LuaScriptInterface::luaMonsterTypeRace(lua_State* L)
{
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			...
			} else if (!tfs_strcmp(race.c_str(), "boss")) {
				monsterType->info.race = RACE_BOSS;
			} else {
...
int LuaScriptInterface::luaMonsterTypeManaCost(lua_State* L)
{
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			...
			monsterType->info.manaCost = getNumber<uint64_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMonsterSpellSetCombatValue(lua_State* L)
{
	...
	MonsterSpell* spell = getUserdata<MonsterSpell>(L, 1);
	if (spell) {
		spell->minCombatValue = getNumber<int64_t>(L, 2);
		spell->maxCombatValue = getNumber<int64_t>(L, 3);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaMonsterSpellSetConditionDamage(lua_State* L)
{
	...
	MonsterSpell* spell = getUserdata<MonsterSpell>(L, 1);
	if (spell) {
		spell->conditionMinDamage = getNumber<int64_t>(L, 2);
		spell->conditionMaxDamage = getNumber<int64_t>(L, 3);
		spell->conditionStartDamage = getNumber<int64_t>(L, 4);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaSpellIcon(lua_State* L)
{
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			pushString(L, spell->getIcon());
		} else {
			spell->setIcon(std::move(getString(L, 2)));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellPower(lua_State* L)
{
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			pushString(L, spell->getPower());
		} else {
			spell->setPower(std::move(getString(L, 2)));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellImage(lua_State* L)
{
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			pushString(L, spell->getImage());
		} else {
			spell->setImage(std::move(getString(L, 2)));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellType(lua_State* L)
{
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			pushString(L, spell->getType());
		} else {
			spell->setType(std::move(getString(L, 2)));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellDesc(lua_State* L)
{
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			pushString(L, spell->getDesc());
		} else {
			spell->setDesc(std::move(getString(L, 2)));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellMana(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setMana(getNumber<uint64_t>(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellManaPercent(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setManaPercent(getNumber<uint64_t>(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaCreatureEventType(lua_State* L)
{
	...
	if (creature) {
		...
		} else if (!tfs_strcmp(tmpStr.c_str(), "endscriptsregen")) {
			creature->setEventType(CREATURE_EVENT_ENDSCRIPTS_REGEN);
		} else if (!tfs_strcmp(tmpStr.c_str(), "minusregenhp")) {
			creature->setEventType(CREATURE_EVENT_MINUSREGENHP);
		} else if (!tfs_strcmp(tmpStr.c_str(), "onhealthdrain")) {
			creature->setEventType(CREATURE_EVENT_HEALTHDRAIN);
		} else if (!tfs_strcmp(tmpStr.c_str(), "reconnect")) {
...
int LuaScriptInterface::luaMoveEventSlot(lua_State* L)
{
	...
	if (moveevent) {
		if (moveevent->getEventType() == MOVE_EVENT_EQUIP || moveevent->getEventType() == MOVE_EVENT_DEEQUIP) {
			...
			} else if (!tfs_strcmp(slotName.c_str(), "gloves")) {
				moveevent->setSlot(SLOTP_GLOVES);
			} else if (!tfs_strcmp(slotName.c_str(), "ring2")) {
				moveevent->setSlot(SLOTP_RING2);
			} else if (!tfs_strcmp(slotName.c_str(), "spell1")) {
				moveevent->setSlot(SLOTP_SPELL1);
			} else if (!tfs_strcmp(slotName.c_str(), "spell2")) {
				moveevent->setSlot(SLOTP_SPELL2);
			} else if (!tfs_strcmp(slotName.c_str(), "spell3")) {
				moveevent->setSlot(SLOTP_SPELL3);
			} else if (!tfs_strcmp(slotName.c_str(), "spell4")) {
				moveevent->setSlot(SLOTP_SPELL4);
			} else if (!tfs_strcmp(slotName.c_str(), "potion1")) {
				moveevent->setSlot(SLOTP_POTION1);
			} else if (!tfs_strcmp(slotName.c_str(), "potion2")) {
				moveevent->setSlot(SLOTP_POTION2);
			} else {
...
int LuaScriptInterface::luaGlobalEventType(lua_State* L)
{
	...
	if (global) {
		...
		} else if (!tfs_strcmp(tmpStr.c_str(), "preremoveitem")) {
			global->setEventType(GLOBALEVENT_PREREMOVEITEM);
		} else {
...
int LuaScriptInterface::luaWeaponMana(lua_State* L)
{
	...
	Weapon* weapon = getUserdata<Weapon>(L, 1);
	if (weapon) {
		weapon->setMana(getNumber<uint64_t>(L, 2));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaWeaponManaPercent(lua_State* L)
{
	...
	Weapon* weapon = getUserdata<Weapon>(L, 1);
	if (weapon) {
		weapon->setManaPercent(getNumber<uint64_t>(L, 2));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaWeaponWandDamage(lua_State* L)
{
	...
	if (weapon) {
		weapon->setMinChange(getNumber<uint64_t>(L, 2));
		if (lua_gettop(L) > 2) {
			weapon->setMaxChange(getNumber<uint64_t>(L, 3));
		} else {
			weapon->setMaxChange(getNumber<uint64_t>(L, 2));
		}
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaDungeonSetCompleteType(lua_State* L)
{
	// dungeon:setCompleteType(DungeonCompleteType)
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		dungeon->setCompleteType(getNumber<DungeonCompleteType>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonGetCompleteType(lua_State* L)
{
	// dungeon:getCompleteType()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		lua_pushnumber(L, static_cast<uint8_t>(dungeon->getCompleteType()));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonSetSolo(lua_State* L)
{
	// dungeon:setSolo(bool)
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		dungeon->setSolo(getBoolean(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonIsSolo(lua_State* L)
{
	// dungeon:isSolo()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		pushBoolean(L, dungeon->isSolo());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonSetRequiredParagon(lua_State* L)
{
	// dungeon:setRequiredParagon(level)
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		dungeon->setRequiredParagon(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonGetRequiredParagon(lua_State* L)
{
	// dungeon:getRequiredParagon()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		lua_pushnumber(L, dungeon->getRequiredParagon());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonSetRequiredItemLevel(lua_State* L)
{
	...
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		dungeon->setRequiredItemLevel(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonGetPlayersCount(lua_State* L)
{
	// dungeon:getPlayers()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		lua_pushnumber(L, dungeon->getPlayers());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureSetProgressBar(lua_State* L)
{
	...
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		uint16_t duration = getNumber<uint32_t>(L, 2);
...
int LuaScriptInterface::luaCreatureAddFear(lua_State* L)
{
	// creature:addFear(duration)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	}
	Creature* attacker = getUserdata<Creature>(L, 2);
	if (!attacker || attacker->isRemoved()) {
		lua_pushnil(L);
		return 1;
	}
	
	uint32_t duration = getNumber<uint32_t>(L, 3, 1000);
	uint32_t interval = getNumber<uint32_t>(L, 4, 200);
	creature->addFear(attacker, duration, interval);
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveFear(lua_State* L)
{
	// creature:removeFear()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
...
int LuaScriptInterface::luaCreatureHasFear(lua_State* L)
{
	// creature:hasFear()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		pushBoolean(L, creature->hasFear());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureAddActiveAura(lua_State* L)
{
	// creature:addActiveAura(id, aura)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		creature->addActiveAura(getNumber<uint8_t>(L, 2), getNumber<uint8_t>(L, 3));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureRemoveActiveAura(lua_State* L)
{
	// creature:removeActiveAura(id)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		creature->removeActiveAura(getNumber<uint8_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureGetActiveAuras(lua_State* L)
{
	// creature:getActiveAuras()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		...
		if (auras.size() > 0) {
			...
			for (const auto& aura : auras) {
				...
				setField(L, "id", aura.first);
				setField(L, "rarity", aura.second);
...
int LuaScriptInterface::luaCreatureSetTitle(lua_State* L)
{
	// creature:setTitle(newTitle)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		creature->setTitle(getString(L, 2), getString(L, 3), getString(L, 4));
		g_game.updateCreatureData(creature);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaCreatureGetTitle(lua_State* L)
{
	// creature:getTitle()
	const Creature* creature = getUserdata<const Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	pushString(L, creature->getTitleText());
	return 1;
}
...
int LuaScriptInterface::luaCreatureGetZoneId(lua_State* L)
{
	...
	lua_pushnumber(L, creature->getZoneId());
	return 1;
}

int LuaScriptInterface::luaCreatureGetBestiaryId(lua_State* L)
{
	// creature:getBestiaryId()
	const Creature* creature = getUserdata<const Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, creature->getBestiaryId());
	return 1;
}

int LuaScriptInterface::luaCreatureSetFlying(lua_State* L)
{
	// creature:setFlying(value)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (creature && !creature->isRemoved()) {
		creature->setFlying(std::move(getBoolean(L, 2, false)));
		g_game.updateCreatureData(creature);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaCreatureIsFlying(lua_State* L)
{
	// creature:isFlying()
	const Creature* creature = getUserdata<const Creature>(L, 1);
	if (!creature || creature->isRemoved()) {
	...
	pushBoolean(L, creature->isFlying());
	return 1;
}
...
{
    // dungeon:addRequiredStorage(key, value, details, error)
    Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
    if (dungeon) {
...
int LuaScriptInterface::luaDungeonAddObjective(lua_State* L)
{
	// dungeon:addObjective(text)
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		dungeon->addObjective(getString(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonGetObjectives(lua_State* L)
{
	// dungeon:getObjectives()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		const std::vector<std::string>& objectives = dungeon->getObjectives();
		if (objectives.size() > 0) {
			int index = 0;
			lua_createtable(L, objectives.size(), 0);
			for (const auto& objective : objectives) {
...
int LuaScriptInterface::luaDungeonGetObjectivesCount(lua_State* L)
{
	// dungeon:getObjectivesCount()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		lua_pushnumber(L, dungeon->getObjectivesCount());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonGetRewardChestPositions(lua_State* L)
{
	// dungeon:getRewardChestPositions()
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		const std::vector<Position>& positions = dungeon->getRewardChestPositions();
		if (positions.size() > 0) {
			int index = 0;
...
int LuaScriptInterface::luaDungeonAddRewardChestPosition(lua_State* L)
{
	// dungeon:addRewardChestPosition(position)
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		dungeon->addRewardChestPosition(getPosition(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
{
	// dungeon:joinQueue(player)
	Dungeon* dungeon = getUserdata<Dungeon>(L, 1);
	if (dungeon) {
		Player* player = getUserdata<Player>(L, 2);
		if (player) {
			pushBoolean(L, dungeon->joinQueue(player, getNumber<uint64_t>(L, 3)));
		}
		else {
			lua_pushnil(L);
		}
...
int LuaScriptInterface::luaDungeonInstanceAddMonster(lua_State* L)
{
	...
	if (instance) {
		...
		if (monster && !monster->isRemoved()) {
			instance->addMonster(monster->getID());
			pushBoolean(L, true);
		}
		else {
			lua_pushnil(L);
...
int LuaScriptInterface::luaDungeonInstanceAddItem(lua_State* L)
{
	// instance:addMonster(monster)
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
...
int LuaScriptInterface::luaDungeonInstanceGetKeyUID(lua_State* L)
{
	// instance:getKeyUID()
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		lua_pushnumber(L, instance->getKeyUID());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonInstanceSetLives(lua_State* L)
{
	// instance:setLives(lives)
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		instance->setLives(getNumber<int8_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonInstanceGetLives(lua_State* L)
{
	// instance:getLives()
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		lua_pushnumber(L, instance->getLives());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonInstanceCompleteObjective(lua_State* L)
{
	// instance:completeObjective(id)
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		instance->completeObjective(getNumber<uint8_t>(L, 2));
		pushBoolean(L, true);
	}
	else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaDungeonInstanceIsObjectiveComplete(lua_State* L)
{
	// instance:isObjectiveComplete(id)
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		pushBoolean(L, instance->isObjectiveComplete(getNumber<uint8_t>(L, 2)));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonInstanceAreAllObjectivesComplete(lua_State* L)
{
	// instance:areAllObjectivesComplete()
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		pushBoolean(L, instance->areAllObjectivesComplete());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaDungeonInstanceGetCompletedObjectivesCount(lua_State* L)
{
	// instance:getCompletedObjectivesCount()
	DungeonInstance* instance = getUserdata<DungeonInstance>(L, 1);
	if (instance) {
		lua_pushnumber(L, instance->getCompletedObjectivesCount());
	}
	else {
		lua_pushnil(L);
	}
...
bool LuaEnvironment::closeState()
{
	...
	// DIAGNOSTIC: Log how many events are being cleaned up
	std::cout << "[LUA CLEANUP] Cleaning up " << timerEvents.size() << " timer events" << std::endl;
