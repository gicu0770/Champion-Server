...
{
	public:
		void onTileCombat(Creature* creature, Tile* tile, Position fromPos) const;
};
...
struct CombatParams {
	...
	int64_t damage2 = 0;
	CombatType_t combatType2 = COMBAT_NONE;
...
class Combat
{
	public:
		...
		static void addDistanceEffect(Creature* caster, const Position& fromPos, const Position& toPos, uint16_t effect, bool type);

		void doCombat(Creature* caster, Creature* target, int8_t multiCast = 0, int16_t critChance = 0, int16_t critMulti = 0, bool gambler = 0, uint32_t uid = 0) const;
		void doCombat(Creature* caster, const Position& position, int8_t multiCast = 0, int16_t critChance = 0, int16_t critMulti = 0, bool gambler = 0, uint32_t uid = 0) const;
		...
		bool setParam(CombatParam_t param, uint64_t value);
		bool setParam(CombatParam_t param, const std::string& value);
	...
	private:
		static void combatTileEffects(const SpectatorVector& spectators, Creature* caster, Tile* tile, const CombatParams& params, Position fromPos);
